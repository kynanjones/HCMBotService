...
var SupplierCompany = /** @class */ (function (_super) {
    ...
    SupplierCompany.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(SupplierCompany);
    };
    /**
    ...
    SupplierCompany.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, SupplierCompany);
    };
    /**
...
(function (SupplierCompany) {
     ...
     */
    SupplierCompany.SUPPLIER = new cloud_sdk_core_1.StringField('Supplier', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[companyCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.COMPANY_CODE = new cloud_sdk_core_1.StringField('CompanyCode', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[authorizationGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.AUTHORIZATION_GROUP = new cloud_sdk_core_1.StringField('AuthorizationGroup', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[companyCodeName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.COMPANY_CODE_NAME = new cloud_sdk_core_1.StringField('CompanyCodeName', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[paymentBlockingReason]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.PAYMENT_BLOCKING_REASON = new cloud_sdk_core_1.StringField('PaymentBlockingReason', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[supplierIsBlockedForPosting]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.SUPPLIER_IS_BLOCKED_FOR_POSTING = new cloud_sdk_core_1.BooleanField('SupplierIsBlockedForPosting', SupplierCompany, 'Edm.Boolean');
    /**
     * Static representation of the [[accountingClerk]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.ACCOUNTING_CLERK = new cloud_sdk_core_1.StringField('AccountingClerk', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[accountingClerkFaxNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.ACCOUNTING_CLERK_FAX_NUMBER = new cloud_sdk_core_1.StringField('AccountingClerkFaxNumber', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[accountingClerkPhoneNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.ACCOUNTING_CLERK_PHONE_NUMBER = new cloud_sdk_core_1.StringField('AccountingClerkPhoneNumber', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[supplierClerk]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.SUPPLIER_CLERK = new cloud_sdk_core_1.StringField('SupplierClerk', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[supplierClerkUrl]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.SUPPLIER_CLERK_URL = new cloud_sdk_core_1.StringField('SupplierClerkURL', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[paymentMethodsList]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.PAYMENT_METHODS_LIST = new cloud_sdk_core_1.StringField('PaymentMethodsList', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[paymentTerms]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.PAYMENT_TERMS = new cloud_sdk_core_1.StringField('PaymentTerms', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[clearCustomerSupplier]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.CLEAR_CUSTOMER_SUPPLIER = new cloud_sdk_core_1.BooleanField('ClearCustomerSupplier', SupplierCompany, 'Edm.Boolean');
    /**
     * Static representation of the [[isToBeLocallyProcessed]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.IS_TO_BE_LOCALLY_PROCESSED = new cloud_sdk_core_1.BooleanField('IsToBeLocallyProcessed', SupplierCompany, 'Edm.Boolean');
    /**
     * Static representation of the [[itemIsToBePaidSeparately]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.ITEM_IS_TO_BE_PAID_SEPARATELY = new cloud_sdk_core_1.BooleanField('ItemIsToBePaidSeparately', SupplierCompany, 'Edm.Boolean');
    /**
     * Static representation of the [[paymentIsToBeSentByEdi]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.PAYMENT_IS_TO_BE_SENT_BY_EDI = new cloud_sdk_core_1.BooleanField('PaymentIsToBeSentByEDI', SupplierCompany, 'Edm.Boolean');
    /**
     * Static representation of the [[houseBank]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.HOUSE_BANK = new cloud_sdk_core_1.StringField('HouseBank', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[checkPaidDurationInDays]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.CHECK_PAID_DURATION_IN_DAYS = new cloud_sdk_core_1.BigNumberField('CheckPaidDurationInDays', SupplierCompany, 'Edm.Decimal');
    /**
     * Static representation of the [[billOfExchLmtAmtInCoCodeCrcy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.BILL_OF_EXCH_LMT_AMT_IN_CO_CODE_CRCY = new cloud_sdk_core_1.BigNumberField('BillOfExchLmtAmtInCoCodeCrcy', SupplierCompany, 'Edm.Decimal');
    /**
     * Static representation of the [[supplierClerkIdBySupplier]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.SUPPLIER_CLERK_ID_BY_SUPPLIER = new cloud_sdk_core_1.StringField('SupplierClerkIDBySupplier', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[reconciliationAccount]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.RECONCILIATION_ACCOUNT = new cloud_sdk_core_1.StringField('ReconciliationAccount', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[interestCalculationCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.INTEREST_CALCULATION_CODE = new cloud_sdk_core_1.StringField('InterestCalculationCode', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[interestCalculationDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.INTEREST_CALCULATION_DATE = new cloud_sdk_core_1.DateField('InterestCalculationDate', SupplierCompany, 'Edm.DateTime');
    /**
     * Static representation of the [[intrstCalcFrequencyInMonths]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.INTRST_CALC_FREQUENCY_IN_MONTHS = new cloud_sdk_core_1.StringField('IntrstCalcFrequencyInMonths', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[supplierHeadOffice]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.SUPPLIER_HEAD_OFFICE = new cloud_sdk_core_1.StringField('SupplierHeadOffice', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[alternativePayee]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.ALTERNATIVE_PAYEE = new cloud_sdk_core_1.StringField('AlternativePayee', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[layoutSortingRule]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.LAYOUT_SORTING_RULE = new cloud_sdk_core_1.StringField('LayoutSortingRule', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[aparToleranceGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.APAR_TOLERANCE_GROUP = new cloud_sdk_core_1.StringField('APARToleranceGroup', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[supplierCertificationDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.SUPPLIER_CERTIFICATION_DATE = new cloud_sdk_core_1.DateField('SupplierCertificationDate', SupplierCompany, 'Edm.DateTime');
    /**
     * Static representation of the [[supplierAccountNote]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.SUPPLIER_ACCOUNT_NOTE = new cloud_sdk_core_1.StringField('SupplierAccountNote', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[withholdingTaxCountry]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.WITHHOLDING_TAX_COUNTRY = new cloud_sdk_core_1.StringField('WithholdingTaxCountry', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[deletionIndicator]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.DELETION_INDICATOR = new cloud_sdk_core_1.BooleanField('DeletionIndicator', SupplierCompany, 'Edm.Boolean');
    /**
     * Static representation of the [[cashPlanningGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.CASH_PLANNING_GROUP = new cloud_sdk_core_1.StringField('CashPlanningGroup', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the [[isToBeCheckedForDuplicates]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.IS_TO_BE_CHECKED_FOR_DUPLICATES = new cloud_sdk_core_1.BooleanField('IsToBeCheckedForDuplicates', SupplierCompany, 'Edm.Boolean');
    /**
     * Static representation of the [[supplierAccountGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.SUPPLIER_ACCOUNT_GROUP = new cloud_sdk_core_1.StringField('SupplierAccountGroup', SupplierCompany, 'Edm.String');
    /**
     * Static representation of the one-to-many navigation property [[toSupplierDunning]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.TO_SUPPLIER_DUNNING = new cloud_sdk_core_1.Link('to_SupplierDunning', SupplierCompany, SupplierDunning_1.SupplierDunning);
    /**
     * Static representation of the one-to-many navigation property [[toSupplierWithHoldingTax]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierCompany.TO_SUPPLIER_WITH_HOLDING_TAX = new cloud_sdk_core_1.Link('to_SupplierWithHoldingTax', SupplierCompany, SupplierWithHoldingTax_1.SupplierWithHoldingTax);
    /**
     ...
     * All fields selector.
     */
    SupplierCompany.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', SupplierCompany);
    /**
