...
var SupplierWithHoldingTax = /** @class */ (function (_super) {
    ...
    SupplierWithHoldingTax.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(SupplierWithHoldingTax);
    };
    /**
    ...
    SupplierWithHoldingTax.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, SupplierWithHoldingTax);
    };
    /**
...
(function (SupplierWithHoldingTax) {
     ...
     */
    SupplierWithHoldingTax.SUPPLIER = new cloud_sdk_core_1.StringField('Supplier', SupplierWithHoldingTax, 'Edm.String');
    /**
     * Static representation of the [[companyCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierWithHoldingTax.COMPANY_CODE = new cloud_sdk_core_1.StringField('CompanyCode', SupplierWithHoldingTax, 'Edm.String');
    /**
     * Static representation of the [[withholdingTaxType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierWithHoldingTax.WITHHOLDING_TAX_TYPE = new cloud_sdk_core_1.StringField('WithholdingTaxType', SupplierWithHoldingTax, 'Edm.String');
    /**
     * Static representation of the [[exemptionDateBegin]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierWithHoldingTax.EXEMPTION_DATE_BEGIN = new cloud_sdk_core_1.DateField('ExemptionDateBegin', SupplierWithHoldingTax, 'Edm.DateTime');
    /**
     * Static representation of the [[exemptionDateEnd]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierWithHoldingTax.EXEMPTION_DATE_END = new cloud_sdk_core_1.DateField('ExemptionDateEnd', SupplierWithHoldingTax, 'Edm.DateTime');
    /**
     * Static representation of the [[exemptionReason]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierWithHoldingTax.EXEMPTION_REASON = new cloud_sdk_core_1.StringField('ExemptionReason', SupplierWithHoldingTax, 'Edm.String');
    /**
     * Static representation of the [[isWithholdingTaxSubject]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierWithHoldingTax.IS_WITHHOLDING_TAX_SUBJECT = new cloud_sdk_core_1.BooleanField('IsWithholdingTaxSubject', SupplierWithHoldingTax, 'Edm.Boolean');
    /**
     * Static representation of the [[recipientType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierWithHoldingTax.RECIPIENT_TYPE = new cloud_sdk_core_1.StringField('RecipientType', SupplierWithHoldingTax, 'Edm.String');
    /**
     * Static representation of the [[withholdingTaxCertificate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierWithHoldingTax.WITHHOLDING_TAX_CERTIFICATE = new cloud_sdk_core_1.StringField('WithholdingTaxCertificate', SupplierWithHoldingTax, 'Edm.String');
    /**
     * Static representation of the [[withholdingTaxCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierWithHoldingTax.WITHHOLDING_TAX_CODE = new cloud_sdk_core_1.StringField('WithholdingTaxCode', SupplierWithHoldingTax, 'Edm.String');
    /**
     * Static representation of the [[withholdingTaxExmptPercent]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierWithHoldingTax.WITHHOLDING_TAX_EXMPT_PERCENT = new cloud_sdk_core_1.BigNumberField('WithholdingTaxExmptPercent', SupplierWithHoldingTax, 'Edm.Decimal');
    /**
     * Static representation of the [[withholdingTaxNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierWithHoldingTax.WITHHOLDING_TAX_NUMBER = new cloud_sdk_core_1.StringField('WithholdingTaxNumber', SupplierWithHoldingTax, 'Edm.String');
    /**
     * Static representation of the [[authorizationGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierWithHoldingTax.AUTHORIZATION_GROUP = new cloud_sdk_core_1.StringField('AuthorizationGroup', SupplierWithHoldingTax, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    SupplierWithHoldingTax.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', SupplierWithHoldingTax);
    /**
