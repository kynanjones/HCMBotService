...
var AddressEmailAddress = /** @class */ (function (_super) {
    ...
    AddressEmailAddress.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(AddressEmailAddress);
    };
    /**
    ...
    AddressEmailAddress.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, AddressEmailAddress);
    };
    /**
...
(function (AddressEmailAddress) {
     ...
     */
    AddressEmailAddress.ADDRESS_ID = new cloud_sdk_core_1.StringField('AddressID', AddressEmailAddress, 'Edm.String');
    /**
     * Static representation of the [[person]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressEmailAddress.PERSON = new cloud_sdk_core_1.StringField('Person', AddressEmailAddress, 'Edm.String');
    /**
     * Static representation of the [[ordinalNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressEmailAddress.ORDINAL_NUMBER = new cloud_sdk_core_1.StringField('OrdinalNumber', AddressEmailAddress, 'Edm.String');
    /**
     * Static representation of the [[isDefaultEmailAddress]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressEmailAddress.IS_DEFAULT_EMAIL_ADDRESS = new cloud_sdk_core_1.BooleanField('IsDefaultEmailAddress', AddressEmailAddress, 'Edm.Boolean');
    /**
     * Static representation of the [[emailAddress]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressEmailAddress.EMAIL_ADDRESS = new cloud_sdk_core_1.StringField('EmailAddress', AddressEmailAddress, 'Edm.String');
    /**
     * Static representation of the [[searchEmailAddress]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressEmailAddress.SEARCH_EMAIL_ADDRESS = new cloud_sdk_core_1.StringField('SearchEmailAddress', AddressEmailAddress, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    AddressEmailAddress.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', AddressEmailAddress);
    /**
