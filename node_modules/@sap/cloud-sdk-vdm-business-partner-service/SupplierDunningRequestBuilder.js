...
var SupplierDunningRequestBuilder = /** @class */ (function (_super) {
    ...
    SupplierDunningRequestBuilder.prototype.getByKey = function (supplier, companyCode, dunningArea) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(SupplierDunning_1.SupplierDunning, {
            Supplier: supplier,
    ...
    SupplierDunningRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(SupplierDunning_1.SupplierDunning);
    };
    /**
    ...
    SupplierDunningRequestBuilder.prototype.create = function (entity) {
        return new cloud_sdk_core_1.CreateRequestBuilder(SupplierDunning_1.SupplierDunning, entity);
    };
    /**
    ...
    SupplierDunningRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(SupplierDunning_1.SupplierDunning, entity);
    };
    SupplierDunningRequestBuilder.prototype.delete = function (supplierOrEntity, companyCode, dunningArea) {
        return new cloud_sdk_core_1.DeleteRequestBuilder(SupplierDunning_1.SupplierDunning, supplierOrEntity instanceof SupplierDunning_1.SupplierDunning ? supplierOrEntity : {
