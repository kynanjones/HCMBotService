...
var CustomerSalesAreaRequestBuilder = /** @class */ (function (_super) {
    ...
    CustomerSalesAreaRequestBuilder.prototype.getByKey = function (customer, salesOrganization, distributionChannel, division) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(CustomerSalesArea_1.CustomerSalesArea, {
            Customer: customer,
    ...
    CustomerSalesAreaRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(CustomerSalesArea_1.CustomerSalesArea);
    };
    /**
    ...
    CustomerSalesAreaRequestBuilder.prototype.create = function (entity) {
        return new cloud_sdk_core_1.CreateRequestBuilder(CustomerSalesArea_1.CustomerSalesArea, entity);
    };
    /**
    ...
    CustomerSalesAreaRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(CustomerSalesArea_1.CustomerSalesArea, entity);
    };
