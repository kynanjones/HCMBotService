...
var BusinessPartnerContactRequestBuilder = /** @class */ (function (_super) {
    ...
    BusinessPartnerContactRequestBuilder.prototype.getByKey = function (relationshipNumber, businessPartnerCompany, businessPartnerPerson, validityEndDate) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(BusinessPartnerContact_1.BusinessPartnerContact, {
    ...
    BusinessPartnerContactRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(BusinessPartnerContact_1.BusinessPartnerContact);
    };
    /**
    ...
    BusinessPartnerContactRequestBuilder.prototype.create = function (entity) {
        return new cloud_sdk_core_1.CreateRequestBuilder(BusinessPartnerContact_1.BusinessPartnerContact, entity);
    };
    /**
    ...
    BusinessPartnerContactRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(BusinessPartnerContact_1.BusinessPartnerContact, entity);
    };
    BusinessPartnerContactRequestBuilder.prototype.delete = function (relationshipNumberOrEntity, businessPartnerCompany, businessPartnerPerson, validityEndDate) {
        return new cloud_sdk_core_1.DeleteRequestBuilder(BusinessPartnerContact_1.BusinessPartnerContact, relationshipNumberOrEntity instanceof BusinessPartnerContact_1.BusinessPartnerContact ? relationshipNumberOrEntity : {
