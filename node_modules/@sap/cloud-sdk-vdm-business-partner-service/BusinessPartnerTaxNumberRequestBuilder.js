...
var BusinessPartnerTaxNumberRequestBuilder = /** @class */ (function (_super) {
    ...
    BusinessPartnerTaxNumberRequestBuilder.prototype.getByKey = function (businessPartner, bpTaxType) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(BusinessPartnerTaxNumber_1.BusinessPartnerTaxNumber, {
    ...
    BusinessPartnerTaxNumberRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(BusinessPartnerTaxNumber_1.BusinessPartnerTaxNumber);
    };
    /**
    ...
    BusinessPartnerTaxNumberRequestBuilder.prototype.create = function (entity) {
        return new cloud_sdk_core_1.CreateRequestBuilder(BusinessPartnerTaxNumber_1.BusinessPartnerTaxNumber, entity);
    };
    /**
    ...
    BusinessPartnerTaxNumberRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(BusinessPartnerTaxNumber_1.BusinessPartnerTaxNumber, entity);
    };
    BusinessPartnerTaxNumberRequestBuilder.prototype.delete = function (businessPartnerOrEntity, bpTaxType) {
        return new cloud_sdk_core_1.DeleteRequestBuilder(BusinessPartnerTaxNumber_1.BusinessPartnerTaxNumber, businessPartnerOrEntity instanceof BusinessPartnerTaxNumber_1.BusinessPartnerTaxNumber ? businessPartnerOrEntity : {
