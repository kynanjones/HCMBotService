...
var BpContactToFuncAndDept = /** @class */ (function (_super) {
    ...
    BpContactToFuncAndDept.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(BpContactToFuncAndDept);
    };
    /**
    ...
    BpContactToFuncAndDept.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, BpContactToFuncAndDept);
    };
    /**
...
(function (BpContactToFuncAndDept) {
     ...
     */
    BpContactToFuncAndDept.RELATIONSHIP_NUMBER = new cloud_sdk_core_1.StringField('RelationshipNumber', BpContactToFuncAndDept, 'Edm.String');
    /**
     * Static representation of the [[businessPartnerCompany]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BpContactToFuncAndDept.BUSINESS_PARTNER_COMPANY = new cloud_sdk_core_1.StringField('BusinessPartnerCompany', BpContactToFuncAndDept, 'Edm.String');
    /**
     * Static representation of the [[businessPartnerPerson]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BpContactToFuncAndDept.BUSINESS_PARTNER_PERSON = new cloud_sdk_core_1.StringField('BusinessPartnerPerson', BpContactToFuncAndDept, 'Edm.String');
    /**
     * Static representation of the [[validityEndDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BpContactToFuncAndDept.VALIDITY_END_DATE = new cloud_sdk_core_1.DateField('ValidityEndDate', BpContactToFuncAndDept, 'Edm.DateTime');
    /**
     * Static representation of the [[contactPersonFunction]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BpContactToFuncAndDept.CONTACT_PERSON_FUNCTION = new cloud_sdk_core_1.StringField('ContactPersonFunction', BpContactToFuncAndDept, 'Edm.String');
    /**
     * Static representation of the [[contactPersonDepartment]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BpContactToFuncAndDept.CONTACT_PERSON_DEPARTMENT = new cloud_sdk_core_1.StringField('ContactPersonDepartment', BpContactToFuncAndDept, 'Edm.String');
    /**
     * Static representation of the [[phoneNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BpContactToFuncAndDept.PHONE_NUMBER = new cloud_sdk_core_1.StringField('PhoneNumber', BpContactToFuncAndDept, 'Edm.String');
    /**
     * Static representation of the [[phoneNumberExtension]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BpContactToFuncAndDept.PHONE_NUMBER_EXTENSION = new cloud_sdk_core_1.StringField('PhoneNumberExtension', BpContactToFuncAndDept, 'Edm.String');
    /**
     * Static representation of the [[faxNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BpContactToFuncAndDept.FAX_NUMBER = new cloud_sdk_core_1.StringField('FaxNumber', BpContactToFuncAndDept, 'Edm.String');
    /**
     * Static representation of the [[faxNumberExtension]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BpContactToFuncAndDept.FAX_NUMBER_EXTENSION = new cloud_sdk_core_1.StringField('FaxNumberExtension', BpContactToFuncAndDept, 'Edm.String');
    /**
     * Static representation of the [[emailAddress]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BpContactToFuncAndDept.EMAIL_ADDRESS = new cloud_sdk_core_1.StringField('EmailAddress', BpContactToFuncAndDept, 'Edm.String');
    /**
     * Static representation of the [[relationshipCategory]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BpContactToFuncAndDept.RELATIONSHIP_CATEGORY = new cloud_sdk_core_1.StringField('RelationshipCategory', BpContactToFuncAndDept, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    BpContactToFuncAndDept.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', BpContactToFuncAndDept);
    /**
