...
var AddressPhoneNumber = /** @class */ (function (_super) {
    ...
    AddressPhoneNumber.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(AddressPhoneNumber);
    };
    /**
    ...
    AddressPhoneNumber.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, AddressPhoneNumber);
    };
    /**
...
(function (AddressPhoneNumber) {
     ...
     */
    AddressPhoneNumber.ADDRESS_ID = new cloud_sdk_core_1.StringField('AddressID', AddressPhoneNumber, 'Edm.String');
    /**
     * Static representation of the [[person]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressPhoneNumber.PERSON = new cloud_sdk_core_1.StringField('Person', AddressPhoneNumber, 'Edm.String');
    /**
     * Static representation of the [[ordinalNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressPhoneNumber.ORDINAL_NUMBER = new cloud_sdk_core_1.StringField('OrdinalNumber', AddressPhoneNumber, 'Edm.String');
    /**
     * Static representation of the [[destinationLocationCountry]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressPhoneNumber.DESTINATION_LOCATION_COUNTRY = new cloud_sdk_core_1.StringField('DestinationLocationCountry', AddressPhoneNumber, 'Edm.String');
    /**
     * Static representation of the [[isDefaultPhoneNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressPhoneNumber.IS_DEFAULT_PHONE_NUMBER = new cloud_sdk_core_1.BooleanField('IsDefaultPhoneNumber', AddressPhoneNumber, 'Edm.Boolean');
    /**
     * Static representation of the [[phoneNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressPhoneNumber.PHONE_NUMBER = new cloud_sdk_core_1.StringField('PhoneNumber', AddressPhoneNumber, 'Edm.String');
    /**
     * Static representation of the [[phoneNumberExtension]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressPhoneNumber.PHONE_NUMBER_EXTENSION = new cloud_sdk_core_1.StringField('PhoneNumberExtension', AddressPhoneNumber, 'Edm.String');
    /**
     * Static representation of the [[internationalPhoneNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressPhoneNumber.INTERNATIONAL_PHONE_NUMBER = new cloud_sdk_core_1.StringField('InternationalPhoneNumber', AddressPhoneNumber, 'Edm.String');
    /**
     * Static representation of the [[phoneNumberType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressPhoneNumber.PHONE_NUMBER_TYPE = new cloud_sdk_core_1.StringField('PhoneNumberType', AddressPhoneNumber, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    AddressPhoneNumber.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', AddressPhoneNumber);
    /**
