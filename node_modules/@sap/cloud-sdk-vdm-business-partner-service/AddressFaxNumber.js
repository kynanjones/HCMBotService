...
var AddressFaxNumber = /** @class */ (function (_super) {
    ...
    AddressFaxNumber.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(AddressFaxNumber);
    };
    /**
    ...
    AddressFaxNumber.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, AddressFaxNumber);
    };
    /**
...
(function (AddressFaxNumber) {
     ...
     */
    AddressFaxNumber.ADDRESS_ID = new cloud_sdk_core_1.StringField('AddressID', AddressFaxNumber, 'Edm.String');
    /**
     * Static representation of the [[person]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressFaxNumber.PERSON = new cloud_sdk_core_1.StringField('Person', AddressFaxNumber, 'Edm.String');
    /**
     * Static representation of the [[ordinalNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressFaxNumber.ORDINAL_NUMBER = new cloud_sdk_core_1.StringField('OrdinalNumber', AddressFaxNumber, 'Edm.String');
    /**
     * Static representation of the [[isDefaultFaxNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressFaxNumber.IS_DEFAULT_FAX_NUMBER = new cloud_sdk_core_1.BooleanField('IsDefaultFaxNumber', AddressFaxNumber, 'Edm.Boolean');
    /**
     * Static representation of the [[faxCountry]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressFaxNumber.FAX_COUNTRY = new cloud_sdk_core_1.StringField('FaxCountry', AddressFaxNumber, 'Edm.String');
    /**
     * Static representation of the [[faxNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressFaxNumber.FAX_NUMBER = new cloud_sdk_core_1.StringField('FaxNumber', AddressFaxNumber, 'Edm.String');
    /**
     * Static representation of the [[faxNumberExtension]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressFaxNumber.FAX_NUMBER_EXTENSION = new cloud_sdk_core_1.StringField('FaxNumberExtension', AddressFaxNumber, 'Edm.String');
    /**
     * Static representation of the [[internationalFaxNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressFaxNumber.INTERNATIONAL_FAX_NUMBER = new cloud_sdk_core_1.StringField('InternationalFaxNumber', AddressFaxNumber, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    AddressFaxNumber.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', AddressFaxNumber);
    /**
