...
import { StringField, BooleanField, BigNumberField, DateField, Link, AllFields, CustomField, Entity, EntityBuilderType, Selectable } from '@sap/cloud-sdk-core';
/**
...
export declare namespace SupplierCompany {
     ...
     */
    const _keyFields: Array<Selectable<SupplierCompany>>;
    /**
