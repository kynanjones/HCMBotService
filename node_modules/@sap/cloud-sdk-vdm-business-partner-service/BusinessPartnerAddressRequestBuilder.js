...
var BusinessPartnerAddressRequestBuilder = /** @class */ (function (_super) {
    ...
    BusinessPartnerAddressRequestBuilder.prototype.getByKey = function (businessPartner, addressId) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(BusinessPartnerAddress_1.BusinessPartnerAddress, {
    ...
    BusinessPartnerAddressRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(BusinessPartnerAddress_1.BusinessPartnerAddress);
    };
    /**
    ...
    BusinessPartnerAddressRequestBuilder.prototype.create = function (entity) {
        return new cloud_sdk_core_1.CreateRequestBuilder(BusinessPartnerAddress_1.BusinessPartnerAddress, entity);
    };
    /**
    ...
    BusinessPartnerAddressRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(BusinessPartnerAddress_1.BusinessPartnerAddress, entity);
    };
    BusinessPartnerAddressRequestBuilder.prototype.delete = function (businessPartnerOrEntity, addressId) {
        return new cloud_sdk_core_1.DeleteRequestBuilder(BusinessPartnerAddress_1.BusinessPartnerAddress, businessPartnerOrEntity instanceof BusinessPartnerAddress_1.BusinessPartnerAddress ? businessPartnerOrEntity : {
