...
var AddressHomePageUrl = /** @class */ (function (_super) {
    ...
    AddressHomePageUrl.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(AddressHomePageUrl);
    };
    /**
    ...
    AddressHomePageUrl.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, AddressHomePageUrl);
    };
    /**
...
(function (AddressHomePageUrl) {
     ...
     */
    AddressHomePageUrl.ADDRESS_ID = new cloud_sdk_core_1.StringField('AddressID', AddressHomePageUrl, 'Edm.String');
    /**
     * Static representation of the [[person]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressHomePageUrl.PERSON = new cloud_sdk_core_1.StringField('Person', AddressHomePageUrl, 'Edm.String');
    /**
     * Static representation of the [[ordinalNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressHomePageUrl.ORDINAL_NUMBER = new cloud_sdk_core_1.StringField('OrdinalNumber', AddressHomePageUrl, 'Edm.String');
    /**
     * Static representation of the [[validityStartDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressHomePageUrl.VALIDITY_START_DATE = new cloud_sdk_core_1.DateField('ValidityStartDate', AddressHomePageUrl, 'Edm.DateTime');
    /**
     * Static representation of the [[isDefaultUrlAddress]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressHomePageUrl.IS_DEFAULT_URL_ADDRESS = new cloud_sdk_core_1.BooleanField('IsDefaultURLAddress', AddressHomePageUrl, 'Edm.Boolean');
    /**
     * Static representation of the [[searchUrlAddress]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressHomePageUrl.SEARCH_URL_ADDRESS = new cloud_sdk_core_1.StringField('SearchURLAddress', AddressHomePageUrl, 'Edm.String');
    /**
     * Static representation of the [[urlFieldLength]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressHomePageUrl.URL_FIELD_LENGTH = new cloud_sdk_core_1.NumberField('URLFieldLength', AddressHomePageUrl, 'Edm.Int16');
    /**
     * Static representation of the [[websiteUrl]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AddressHomePageUrl.WEBSITE_URL = new cloud_sdk_core_1.StringField('WebsiteURL', AddressHomePageUrl, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    AddressHomePageUrl.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', AddressHomePageUrl);
    /**
