...
var CustomerCompanyRequestBuilder = /** @class */ (function (_super) {
    ...
    CustomerCompanyRequestBuilder.prototype.getByKey = function (customer, companyCode) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(CustomerCompany_1.CustomerCompany, {
            Customer: customer,
    ...
    CustomerCompanyRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(CustomerCompany_1.CustomerCompany);
    };
    /**
    ...
    CustomerCompanyRequestBuilder.prototype.create = function (entity) {
        return new cloud_sdk_core_1.CreateRequestBuilder(CustomerCompany_1.CustomerCompany, entity);
    };
    /**
    ...
    CustomerCompanyRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(CustomerCompany_1.CustomerCompany, entity);
    };
