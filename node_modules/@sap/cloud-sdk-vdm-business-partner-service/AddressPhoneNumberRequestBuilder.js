...
var AddressPhoneNumberRequestBuilder = /** @class */ (function (_super) {
    ...
    AddressPhoneNumberRequestBuilder.prototype.getByKey = function (addressId, person, ordinalNumber) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(AddressPhoneNumber_1.AddressPhoneNumber, {
            AddressID: addressId,
            Person: person,
    ...
    AddressPhoneNumberRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(AddressPhoneNumber_1.AddressPhoneNumber);
    };
    /**
    ...
    AddressPhoneNumberRequestBuilder.prototype.create = function (entity) {
        return new cloud_sdk_core_1.CreateRequestBuilder(AddressPhoneNumber_1.AddressPhoneNumber, entity);
    };
    /**
    ...
    AddressPhoneNumberRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(AddressPhoneNumber_1.AddressPhoneNumber, entity);
    };
    AddressPhoneNumberRequestBuilder.prototype.delete = function (addressIdOrEntity, person, ordinalNumber) {
        return new cloud_sdk_core_1.DeleteRequestBuilder(AddressPhoneNumber_1.AddressPhoneNumber, addressIdOrEntity instanceof AddressPhoneNumber_1.AddressPhoneNumber ? addressIdOrEntity : {
