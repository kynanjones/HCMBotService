...
var BuPaAddressUsageRequestBuilder = /** @class */ (function (_super) {
    ...
    BuPaAddressUsageRequestBuilder.prototype.getByKey = function (businessPartner, validityEndDate, addressUsage, addressId) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(BuPaAddressUsage_1.BuPaAddressUsage, {
    ...
    BuPaAddressUsageRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(BuPaAddressUsage_1.BuPaAddressUsage);
    };
    /**
    ...
    BuPaAddressUsageRequestBuilder.prototype.create = function (entity) {
        return new cloud_sdk_core_1.CreateRequestBuilder(BuPaAddressUsage_1.BuPaAddressUsage, entity);
    };
    /**
    ...
    BuPaAddressUsageRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(BuPaAddressUsage_1.BuPaAddressUsage, entity);
    };
    BuPaAddressUsageRequestBuilder.prototype.delete = function (businessPartnerOrEntity, validityEndDate, addressUsage, addressId) {
        return new cloud_sdk_core_1.DeleteRequestBuilder(BuPaAddressUsage_1.BuPaAddressUsage, businessPartnerOrEntity instanceof BuPaAddressUsage_1.BuPaAddressUsage ? businessPartnerOrEntity : {
