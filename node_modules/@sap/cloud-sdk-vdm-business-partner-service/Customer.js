...
var Customer = /** @class */ (function (_super) {
    ...
    Customer.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(Customer);
    };
    /**
    ...
    Customer.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, Customer);
    };
    /**
...
(function (Customer) {
     ...
     */
    Customer.CUSTOMER = new cloud_sdk_core_1.StringField('Customer', Customer, 'Edm.String');
    /**
     * Static representation of the [[authorizationGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.AUTHORIZATION_GROUP = new cloud_sdk_core_1.StringField('AuthorizationGroup', Customer, 'Edm.String');
    /**
     * Static representation of the [[billingIsBlockedForCustomer]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.BILLING_IS_BLOCKED_FOR_CUSTOMER = new cloud_sdk_core_1.StringField('BillingIsBlockedForCustomer', Customer, 'Edm.String');
    /**
     * Static representation of the [[createdByUser]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.CREATED_BY_USER = new cloud_sdk_core_1.StringField('CreatedByUser', Customer, 'Edm.String');
    /**
     * Static representation of the [[creationDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.CREATION_DATE = new cloud_sdk_core_1.DateField('CreationDate', Customer, 'Edm.DateTime');
    /**
     * Static representation of the [[customerAccountGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.CUSTOMER_ACCOUNT_GROUP = new cloud_sdk_core_1.StringField('CustomerAccountGroup', Customer, 'Edm.String');
    /**
     * Static representation of the [[customerClassification]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.CUSTOMER_CLASSIFICATION = new cloud_sdk_core_1.StringField('CustomerClassification', Customer, 'Edm.String');
    /**
     * Static representation of the [[customerFullName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.CUSTOMER_FULL_NAME = new cloud_sdk_core_1.StringField('CustomerFullName', Customer, 'Edm.String');
    /**
     * Static representation of the [[customerName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.CUSTOMER_NAME = new cloud_sdk_core_1.StringField('CustomerName', Customer, 'Edm.String');
    /**
     * Static representation of the [[deliveryIsBlocked]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.DELIVERY_IS_BLOCKED = new cloud_sdk_core_1.StringField('DeliveryIsBlocked', Customer, 'Edm.String');
    /**
     * Static representation of the [[nfPartnerIsNaturalPerson]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.NF_PARTNER_IS_NATURAL_PERSON = new cloud_sdk_core_1.StringField('NFPartnerIsNaturalPerson', Customer, 'Edm.String');
    /**
     * Static representation of the [[orderIsBlockedForCustomer]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.ORDER_IS_BLOCKED_FOR_CUSTOMER = new cloud_sdk_core_1.StringField('OrderIsBlockedForCustomer', Customer, 'Edm.String');
    /**
     * Static representation of the [[postingIsBlocked]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.POSTING_IS_BLOCKED = new cloud_sdk_core_1.BooleanField('PostingIsBlocked', Customer, 'Edm.Boolean');
    /**
     * Static representation of the [[supplier]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.SUPPLIER = new cloud_sdk_core_1.StringField('Supplier', Customer, 'Edm.String');
    /**
     * Static representation of the [[customerCorporateGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.CUSTOMER_CORPORATE_GROUP = new cloud_sdk_core_1.StringField('CustomerCorporateGroup', Customer, 'Edm.String');
    /**
     * Static representation of the [[fiscalAddress]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.FISCAL_ADDRESS = new cloud_sdk_core_1.StringField('FiscalAddress', Customer, 'Edm.String');
    /**
     * Static representation of the [[industry]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.INDUSTRY = new cloud_sdk_core_1.StringField('Industry', Customer, 'Edm.String');
    /**
     * Static representation of the [[industryCode1]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.INDUSTRY_CODE_1 = new cloud_sdk_core_1.StringField('IndustryCode1', Customer, 'Edm.String');
    /**
     * Static representation of the [[industryCode2]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.INDUSTRY_CODE_2 = new cloud_sdk_core_1.StringField('IndustryCode2', Customer, 'Edm.String');
    /**
     * Static representation of the [[industryCode3]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.INDUSTRY_CODE_3 = new cloud_sdk_core_1.StringField('IndustryCode3', Customer, 'Edm.String');
    /**
     * Static representation of the [[industryCode4]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.INDUSTRY_CODE_4 = new cloud_sdk_core_1.StringField('IndustryCode4', Customer, 'Edm.String');
    /**
     * Static representation of the [[industryCode5]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.INDUSTRY_CODE_5 = new cloud_sdk_core_1.StringField('IndustryCode5', Customer, 'Edm.String');
    /**
     * Static representation of the [[internationalLocationNumber1]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.INTERNATIONAL_LOCATION_NUMBER_1 = new cloud_sdk_core_1.StringField('InternationalLocationNumber1', Customer, 'Edm.String');
    /**
     * Static representation of the [[nielsenRegion]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.NIELSEN_REGION = new cloud_sdk_core_1.StringField('NielsenRegion', Customer, 'Edm.String');
    /**
     * Static representation of the [[responsibleType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.RESPONSIBLE_TYPE = new cloud_sdk_core_1.StringField('ResponsibleType', Customer, 'Edm.String');
    /**
     * Static representation of the [[taxNumber1]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.TAX_NUMBER_1 = new cloud_sdk_core_1.StringField('TaxNumber1', Customer, 'Edm.String');
    /**
     * Static representation of the [[taxNumber2]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.TAX_NUMBER_2 = new cloud_sdk_core_1.StringField('TaxNumber2', Customer, 'Edm.String');
    /**
     * Static representation of the [[taxNumber3]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.TAX_NUMBER_3 = new cloud_sdk_core_1.StringField('TaxNumber3', Customer, 'Edm.String');
    /**
     * Static representation of the [[taxNumber4]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.TAX_NUMBER_4 = new cloud_sdk_core_1.StringField('TaxNumber4', Customer, 'Edm.String');
    /**
     * Static representation of the [[taxNumber5]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.TAX_NUMBER_5 = new cloud_sdk_core_1.StringField('TaxNumber5', Customer, 'Edm.String');
    /**
     * Static representation of the [[taxNumberType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.TAX_NUMBER_TYPE = new cloud_sdk_core_1.StringField('TaxNumberType', Customer, 'Edm.String');
    /**
     * Static representation of the [[vatRegistration]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.VAT_REGISTRATION = new cloud_sdk_core_1.StringField('VATRegistration', Customer, 'Edm.String');
    /**
     * Static representation of the [[deletionIndicator]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.DELETION_INDICATOR = new cloud_sdk_core_1.BooleanField('DeletionIndicator', Customer, 'Edm.Boolean');
    /**
     * Static representation of the one-to-many navigation property [[toCustomerCompany]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.TO_CUSTOMER_COMPANY = new cloud_sdk_core_1.Link('to_CustomerCompany', Customer, CustomerCompany_1.CustomerCompany);
    /**
     * Static representation of the one-to-many navigation property [[toCustomerSalesArea]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Customer.TO_CUSTOMER_SALES_AREA = new cloud_sdk_core_1.Link('to_CustomerSalesArea', Customer, CustomerSalesArea_1.CustomerSalesArea);
    /**
     ...
     * All fields selector.
     */
    Customer.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', Customer);
    /**
