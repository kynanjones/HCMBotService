...
var AddressEmailAddressRequestBuilder = /** @class */ (function (_super) {
    ...
    AddressEmailAddressRequestBuilder.prototype.getByKey = function (addressId, person, ordinalNumber) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(AddressEmailAddress_1.AddressEmailAddress, {
            AddressID: addressId,
            Person: person,
    ...
    AddressEmailAddressRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(AddressEmailAddress_1.AddressEmailAddress);
    };
    /**
    ...
    AddressEmailAddressRequestBuilder.prototype.create = function (entity) {
        return new cloud_sdk_core_1.CreateRequestBuilder(AddressEmailAddress_1.AddressEmailAddress, entity);
    };
    /**
    ...
    AddressEmailAddressRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(AddressEmailAddress_1.AddressEmailAddress, entity);
    };
    AddressEmailAddressRequestBuilder.prototype.delete = function (addressIdOrEntity, person, ordinalNumber) {
        return new cloud_sdk_core_1.DeleteRequestBuilder(AddressEmailAddress_1.AddressEmailAddress, addressIdOrEntity instanceof AddressEmailAddress_1.AddressEmailAddress ? addressIdOrEntity : {
