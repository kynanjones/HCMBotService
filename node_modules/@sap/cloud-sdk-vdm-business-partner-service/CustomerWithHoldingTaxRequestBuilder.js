...
var CustomerWithHoldingTaxRequestBuilder = /** @class */ (function (_super) {
    ...
    CustomerWithHoldingTaxRequestBuilder.prototype.getByKey = function (customer, companyCode, withholdingTaxType) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(CustomerWithHoldingTax_1.CustomerWithHoldingTax, {
            Customer: customer,
    ...
    CustomerWithHoldingTaxRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(CustomerWithHoldingTax_1.CustomerWithHoldingTax);
    };
    /**
    ...
    CustomerWithHoldingTaxRequestBuilder.prototype.create = function (entity) {
        return new cloud_sdk_core_1.CreateRequestBuilder(CustomerWithHoldingTax_1.CustomerWithHoldingTax, entity);
    };
    /**
    ...
    CustomerWithHoldingTaxRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(CustomerWithHoldingTax_1.CustomerWithHoldingTax, entity);
    };
    CustomerWithHoldingTaxRequestBuilder.prototype.delete = function (customerOrEntity, companyCode, withholdingTaxType) {
        return new cloud_sdk_core_1.DeleteRequestBuilder(CustomerWithHoldingTax_1.CustomerWithHoldingTax, customerOrEntity instanceof CustomerWithHoldingTax_1.CustomerWithHoldingTax ? customerOrEntity : {
