...
var BuPaAddressUsage = /** @class */ (function (_super) {
    ...
    BuPaAddressUsage.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(BuPaAddressUsage);
    };
    /**
    ...
    BuPaAddressUsage.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, BuPaAddressUsage);
    };
    /**
...
(function (BuPaAddressUsage) {
     ...
     */
    BuPaAddressUsage.BUSINESS_PARTNER = new cloud_sdk_core_1.StringField('BusinessPartner', BuPaAddressUsage, 'Edm.String');
    /**
     * Static representation of the [[validityEndDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BuPaAddressUsage.VALIDITY_END_DATE = new cloud_sdk_core_1.DateField('ValidityEndDate', BuPaAddressUsage, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[addressUsage]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BuPaAddressUsage.ADDRESS_USAGE = new cloud_sdk_core_1.StringField('AddressUsage', BuPaAddressUsage, 'Edm.String');
    /**
     * Static representation of the [[addressId]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BuPaAddressUsage.ADDRESS_ID = new cloud_sdk_core_1.StringField('AddressID', BuPaAddressUsage, 'Edm.String');
    /**
     * Static representation of the [[validityStartDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BuPaAddressUsage.VALIDITY_START_DATE = new cloud_sdk_core_1.DateField('ValidityStartDate', BuPaAddressUsage, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[standardUsage]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BuPaAddressUsage.STANDARD_USAGE = new cloud_sdk_core_1.BooleanField('StandardUsage', BuPaAddressUsage, 'Edm.Boolean');
    /**
     * Static representation of the [[authorizationGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BuPaAddressUsage.AUTHORIZATION_GROUP = new cloud_sdk_core_1.StringField('AuthorizationGroup', BuPaAddressUsage, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    BuPaAddressUsage.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', BuPaAddressUsage);
    /**
