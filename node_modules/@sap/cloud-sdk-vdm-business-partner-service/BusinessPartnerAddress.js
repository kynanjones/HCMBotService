...
var BusinessPartnerAddress = /** @class */ (function (_super) {
    ...
    BusinessPartnerAddress.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(BusinessPartnerAddress);
    };
    /**
    ...
    BusinessPartnerAddress.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, BusinessPartnerAddress);
    };
    /**
...
(function (BusinessPartnerAddress) {
     ...
     */
    BusinessPartnerAddress.BUSINESS_PARTNER = new cloud_sdk_core_1.StringField('BusinessPartner', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[addressId]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.ADDRESS_ID = new cloud_sdk_core_1.StringField('AddressID', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[validityStartDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.VALIDITY_START_DATE = new cloud_sdk_core_1.DateField('ValidityStartDate', BusinessPartnerAddress, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[validityEndDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.VALIDITY_END_DATE = new cloud_sdk_core_1.DateField('ValidityEndDate', BusinessPartnerAddress, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[authorizationGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.AUTHORIZATION_GROUP = new cloud_sdk_core_1.StringField('AuthorizationGroup', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[addressUuid]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.ADDRESS_UUID = new cloud_sdk_core_1.StringField('AddressUUID', BusinessPartnerAddress, 'Edm.Guid');
    /**
     * Static representation of the [[additionalStreetPrefixName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.ADDITIONAL_STREET_PREFIX_NAME = new cloud_sdk_core_1.StringField('AdditionalStreetPrefixName', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[additionalStreetSuffixName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.ADDITIONAL_STREET_SUFFIX_NAME = new cloud_sdk_core_1.StringField('AdditionalStreetSuffixName', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[addressTimeZone]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.ADDRESS_TIME_ZONE = new cloud_sdk_core_1.StringField('AddressTimeZone', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[careOfName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.CARE_OF_NAME = new cloud_sdk_core_1.StringField('CareOfName', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[cityCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.CITY_CODE = new cloud_sdk_core_1.StringField('CityCode', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[cityName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.CITY_NAME = new cloud_sdk_core_1.StringField('CityName', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[companyPostalCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.COMPANY_POSTAL_CODE = new cloud_sdk_core_1.StringField('CompanyPostalCode', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[country]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.COUNTRY = new cloud_sdk_core_1.StringField('Country', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[county]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.COUNTY = new cloud_sdk_core_1.StringField('County', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[deliveryServiceNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.DELIVERY_SERVICE_NUMBER = new cloud_sdk_core_1.StringField('DeliveryServiceNumber', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[deliveryServiceTypeCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.DELIVERY_SERVICE_TYPE_CODE = new cloud_sdk_core_1.StringField('DeliveryServiceTypeCode', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[district]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.DISTRICT = new cloud_sdk_core_1.StringField('District', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[formOfAddress]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.FORM_OF_ADDRESS = new cloud_sdk_core_1.StringField('FormOfAddress', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[fullName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.FULL_NAME = new cloud_sdk_core_1.StringField('FullName', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[homeCityName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.HOME_CITY_NAME = new cloud_sdk_core_1.StringField('HomeCityName', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[houseNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.HOUSE_NUMBER = new cloud_sdk_core_1.StringField('HouseNumber', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[houseNumberSupplementText]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.HOUSE_NUMBER_SUPPLEMENT_TEXT = new cloud_sdk_core_1.StringField('HouseNumberSupplementText', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[language]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.LANGUAGE = new cloud_sdk_core_1.StringField('Language', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[poBox]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.PO_BOX = new cloud_sdk_core_1.StringField('POBox', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[poBoxDeviatingCityName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.PO_BOX_DEVIATING_CITY_NAME = new cloud_sdk_core_1.StringField('POBoxDeviatingCityName', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[poBoxDeviatingCountry]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.PO_BOX_DEVIATING_COUNTRY = new cloud_sdk_core_1.StringField('POBoxDeviatingCountry', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[poBoxDeviatingRegion]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.PO_BOX_DEVIATING_REGION = new cloud_sdk_core_1.StringField('POBoxDeviatingRegion', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[poBoxIsWithoutNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.PO_BOX_IS_WITHOUT_NUMBER = new cloud_sdk_core_1.BooleanField('POBoxIsWithoutNumber', BusinessPartnerAddress, 'Edm.Boolean');
    /**
     * Static representation of the [[poBoxLobbyName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.PO_BOX_LOBBY_NAME = new cloud_sdk_core_1.StringField('POBoxLobbyName', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[poBoxPostalCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.PO_BOX_POSTAL_CODE = new cloud_sdk_core_1.StringField('POBoxPostalCode', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[person]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.PERSON = new cloud_sdk_core_1.StringField('Person', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[postalCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.POSTAL_CODE = new cloud_sdk_core_1.StringField('PostalCode', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[prfrdCommMediumType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.PRFRD_COMM_MEDIUM_TYPE = new cloud_sdk_core_1.StringField('PrfrdCommMediumType', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[region]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.REGION = new cloud_sdk_core_1.StringField('Region', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[streetName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.STREET_NAME = new cloud_sdk_core_1.StringField('StreetName', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[streetPrefixName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.STREET_PREFIX_NAME = new cloud_sdk_core_1.StringField('StreetPrefixName', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[streetSuffixName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.STREET_SUFFIX_NAME = new cloud_sdk_core_1.StringField('StreetSuffixName', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[taxJurisdiction]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.TAX_JURISDICTION = new cloud_sdk_core_1.StringField('TaxJurisdiction', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[transportZone]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.TRANSPORT_ZONE = new cloud_sdk_core_1.StringField('TransportZone', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the [[addressIdByExternalSystem]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.ADDRESS_ID_BY_EXTERNAL_SYSTEM = new cloud_sdk_core_1.StringField('AddressIDByExternalSystem', BusinessPartnerAddress, 'Edm.String');
    /**
     * Static representation of the one-to-many navigation property [[toAddressUsage]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.TO_ADDRESS_USAGE = new cloud_sdk_core_1.Link('to_AddressUsage', BusinessPartnerAddress, BuPaAddressUsage_1.BuPaAddressUsage);
    /**
     * Static representation of the one-to-many navigation property [[toEmailAddress]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.TO_EMAIL_ADDRESS = new cloud_sdk_core_1.Link('to_EmailAddress', BusinessPartnerAddress, AddressEmailAddress_1.AddressEmailAddress);
    /**
     * Static representation of the one-to-many navigation property [[toFaxNumber]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.TO_FAX_NUMBER = new cloud_sdk_core_1.Link('to_FaxNumber', BusinessPartnerAddress, AddressFaxNumber_1.AddressFaxNumber);
    /**
     * Static representation of the one-to-many navigation property [[toMobilePhoneNumber]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.TO_MOBILE_PHONE_NUMBER = new cloud_sdk_core_1.Link('to_MobilePhoneNumber', BusinessPartnerAddress, AddressPhoneNumber_1.AddressPhoneNumber);
    /**
     * Static representation of the one-to-many navigation property [[toPhoneNumber]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.TO_PHONE_NUMBER = new cloud_sdk_core_1.Link('to_PhoneNumber', BusinessPartnerAddress, AddressPhoneNumber_1.AddressPhoneNumber);
    /**
     * Static representation of the one-to-many navigation property [[toUrlAddress]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerAddress.TO_URL_ADDRESS = new cloud_sdk_core_1.Link('to_URLAddress', BusinessPartnerAddress, AddressHomePageUrl_1.AddressHomePageUrl);
    /**
     ...
     * All fields selector.
     */
    BusinessPartnerAddress.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', BusinessPartnerAddress);
    /**
