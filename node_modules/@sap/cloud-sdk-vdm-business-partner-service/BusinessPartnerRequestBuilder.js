...
var BusinessPartnerRequestBuilder = /** @class */ (function (_super) {
    ...
    BusinessPartnerRequestBuilder.prototype.getByKey = function (businessPartner) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(BusinessPartner_1.BusinessPartner, { BusinessPartner: businessPartner });
    };
    /**
    ...
    BusinessPartnerRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(BusinessPartner_1.BusinessPartner);
    };
    /**
    ...
    BusinessPartnerRequestBuilder.prototype.create = function (entity) {
        return new cloud_sdk_core_1.CreateRequestBuilder(BusinessPartner_1.BusinessPartner, entity);
    };
    /**
    ...
    BusinessPartnerRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(BusinessPartner_1.BusinessPartner, entity);
    };
