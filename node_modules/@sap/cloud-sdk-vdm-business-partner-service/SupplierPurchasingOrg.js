...
var SupplierPurchasingOrg = /** @class */ (function (_super) {
    ...
    SupplierPurchasingOrg.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(SupplierPurchasingOrg);
    };
    /**
    ...
    SupplierPurchasingOrg.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, SupplierPurchasingOrg);
    };
    /**
...
(function (SupplierPurchasingOrg) {
     ...
     */
    SupplierPurchasingOrg.SUPPLIER = new cloud_sdk_core_1.StringField('Supplier', SupplierPurchasingOrg, 'Edm.String');
    /**
     * Static representation of the [[purchasingOrganization]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.PURCHASING_ORGANIZATION = new cloud_sdk_core_1.StringField('PurchasingOrganization', SupplierPurchasingOrg, 'Edm.String');
    /**
     * Static representation of the [[calculationSchemaGroupCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.CALCULATION_SCHEMA_GROUP_CODE = new cloud_sdk_core_1.StringField('CalculationSchemaGroupCode', SupplierPurchasingOrg, 'Edm.String');
    /**
     * Static representation of the [[deletionIndicator]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.DELETION_INDICATOR = new cloud_sdk_core_1.BooleanField('DeletionIndicator', SupplierPurchasingOrg, 'Edm.Boolean');
    /**
     * Static representation of the [[incotermsClassification]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.INCOTERMS_CLASSIFICATION = new cloud_sdk_core_1.StringField('IncotermsClassification', SupplierPurchasingOrg, 'Edm.String');
    /**
     * Static representation of the [[incotermsTransferLocation]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.INCOTERMS_TRANSFER_LOCATION = new cloud_sdk_core_1.StringField('IncotermsTransferLocation', SupplierPurchasingOrg, 'Edm.String');
    /**
     * Static representation of the [[incotermsVersion]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.INCOTERMS_VERSION = new cloud_sdk_core_1.StringField('IncotermsVersion', SupplierPurchasingOrg, 'Edm.String');
    /**
     * Static representation of the [[incotermsLocation1]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.INCOTERMS_LOCATION_1 = new cloud_sdk_core_1.StringField('IncotermsLocation1', SupplierPurchasingOrg, 'Edm.String');
    /**
     * Static representation of the [[incotermsLocation2]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.INCOTERMS_LOCATION_2 = new cloud_sdk_core_1.StringField('IncotermsLocation2', SupplierPurchasingOrg, 'Edm.String');
    /**
     * Static representation of the [[invoiceIsGoodsReceiptBased]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.INVOICE_IS_GOODS_RECEIPT_BASED = new cloud_sdk_core_1.BooleanField('InvoiceIsGoodsReceiptBased', SupplierPurchasingOrg, 'Edm.Boolean');
    /**
     * Static representation of the [[materialPlannedDeliveryDurn]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.MATERIAL_PLANNED_DELIVERY_DURN = new cloud_sdk_core_1.BigNumberField('MaterialPlannedDeliveryDurn', SupplierPurchasingOrg, 'Edm.Decimal');
    /**
     * Static representation of the [[minimumOrderAmount]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.MINIMUM_ORDER_AMOUNT = new cloud_sdk_core_1.BigNumberField('MinimumOrderAmount', SupplierPurchasingOrg, 'Edm.Decimal');
    /**
     * Static representation of the [[paymentTerms]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.PAYMENT_TERMS = new cloud_sdk_core_1.StringField('PaymentTerms', SupplierPurchasingOrg, 'Edm.String');
    /**
     * Static representation of the [[pricingDateControl]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.PRICING_DATE_CONTROL = new cloud_sdk_core_1.StringField('PricingDateControl', SupplierPurchasingOrg, 'Edm.String');
    /**
     * Static representation of the [[purOrdAutoGenerationIsAllowed]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.PUR_ORD_AUTO_GENERATION_IS_ALLOWED = new cloud_sdk_core_1.BooleanField('PurOrdAutoGenerationIsAllowed', SupplierPurchasingOrg, 'Edm.Boolean');
    /**
     * Static representation of the [[purchaseOrderCurrency]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.PURCHASE_ORDER_CURRENCY = new cloud_sdk_core_1.StringField('PurchaseOrderCurrency', SupplierPurchasingOrg, 'Edm.String');
    /**
     * Static representation of the [[purchasingGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.PURCHASING_GROUP = new cloud_sdk_core_1.StringField('PurchasingGroup', SupplierPurchasingOrg, 'Edm.String');
    /**
     * Static representation of the [[purchasingIsBlockedForSupplier]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.PURCHASING_IS_BLOCKED_FOR_SUPPLIER = new cloud_sdk_core_1.BooleanField('PurchasingIsBlockedForSupplier', SupplierPurchasingOrg, 'Edm.Boolean');
    /**
     * Static representation of the [[shippingCondition]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.SHIPPING_CONDITION = new cloud_sdk_core_1.StringField('ShippingCondition', SupplierPurchasingOrg, 'Edm.String');
    /**
     * Static representation of the [[supplierAbcClassificationCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.SUPPLIER_ABC_CLASSIFICATION_CODE = new cloud_sdk_core_1.StringField('SupplierABCClassificationCode', SupplierPurchasingOrg, 'Edm.String');
    /**
     * Static representation of the [[supplierPhoneNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.SUPPLIER_PHONE_NUMBER = new cloud_sdk_core_1.StringField('SupplierPhoneNumber', SupplierPurchasingOrg, 'Edm.String');
    /**
     * Static representation of the [[supplierRespSalesPersonName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.SUPPLIER_RESP_SALES_PERSON_NAME = new cloud_sdk_core_1.StringField('SupplierRespSalesPersonName', SupplierPurchasingOrg, 'Edm.String');
    /**
     * Static representation of the [[authorizationGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.AUTHORIZATION_GROUP = new cloud_sdk_core_1.StringField('AuthorizationGroup', SupplierPurchasingOrg, 'Edm.String');
    /**
     * Static representation of the [[supplierAccountGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.SUPPLIER_ACCOUNT_GROUP = new cloud_sdk_core_1.StringField('SupplierAccountGroup', SupplierPurchasingOrg, 'Edm.String');
    /**
     * Static representation of the one-to-many navigation property [[toPartnerFunction]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPurchasingOrg.TO_PARTNER_FUNCTION = new cloud_sdk_core_1.Link('to_PartnerFunction', SupplierPurchasingOrg, SupplierPartnerFunc_1.SupplierPartnerFunc);
    /**
     ...
     * All fields selector.
     */
    SupplierPurchasingOrg.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', SupplierPurchasingOrg);
    /**
