...
var CustSalesPartnerFunc = /** @class */ (function (_super) {
    ...
    CustSalesPartnerFunc.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(CustSalesPartnerFunc);
    };
    /**
    ...
    CustSalesPartnerFunc.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, CustSalesPartnerFunc);
    };
    /**
...
(function (CustSalesPartnerFunc) {
     ...
     */
    CustSalesPartnerFunc.CUSTOMER = new cloud_sdk_core_1.StringField('Customer', CustSalesPartnerFunc, 'Edm.String');
    /**
     * Static representation of the [[salesOrganization]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustSalesPartnerFunc.SALES_ORGANIZATION = new cloud_sdk_core_1.StringField('SalesOrganization', CustSalesPartnerFunc, 'Edm.String');
    /**
     * Static representation of the [[distributionChannel]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustSalesPartnerFunc.DISTRIBUTION_CHANNEL = new cloud_sdk_core_1.StringField('DistributionChannel', CustSalesPartnerFunc, 'Edm.String');
    /**
     * Static representation of the [[division]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustSalesPartnerFunc.DIVISION = new cloud_sdk_core_1.StringField('Division', CustSalesPartnerFunc, 'Edm.String');
    /**
     * Static representation of the [[partnerCounter]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustSalesPartnerFunc.PARTNER_COUNTER = new cloud_sdk_core_1.StringField('PartnerCounter', CustSalesPartnerFunc, 'Edm.String');
    /**
     * Static representation of the [[partnerFunction]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustSalesPartnerFunc.PARTNER_FUNCTION = new cloud_sdk_core_1.StringField('PartnerFunction', CustSalesPartnerFunc, 'Edm.String');
    /**
     * Static representation of the [[bpCustomerNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustSalesPartnerFunc.BP_CUSTOMER_NUMBER = new cloud_sdk_core_1.StringField('BPCustomerNumber', CustSalesPartnerFunc, 'Edm.String');
    /**
     * Static representation of the [[customerPartnerDescription]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustSalesPartnerFunc.CUSTOMER_PARTNER_DESCRIPTION = new cloud_sdk_core_1.StringField('CustomerPartnerDescription', CustSalesPartnerFunc, 'Edm.String');
    /**
     * Static representation of the [[defaultPartner]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustSalesPartnerFunc.DEFAULT_PARTNER = new cloud_sdk_core_1.BooleanField('DefaultPartner', CustSalesPartnerFunc, 'Edm.Boolean');
    /**
     * Static representation of the [[authorizationGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustSalesPartnerFunc.AUTHORIZATION_GROUP = new cloud_sdk_core_1.StringField('AuthorizationGroup', CustSalesPartnerFunc, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    CustSalesPartnerFunc.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', CustSalesPartnerFunc);
    /**
