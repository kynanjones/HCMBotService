...
var SupplierPartnerFuncRequestBuilder = /** @class */ (function (_super) {
    ...
    SupplierPartnerFuncRequestBuilder.prototype.getByKey = function (supplier, purchasingOrganization, supplierSubrange, plant, partnerFunction, partnerCounter) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(SupplierPartnerFunc_1.SupplierPartnerFunc, {
            Supplier: supplier,
    ...
    SupplierPartnerFuncRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(SupplierPartnerFunc_1.SupplierPartnerFunc);
    };
    /**
    ...
    SupplierPartnerFuncRequestBuilder.prototype.create = function (entity) {
        return new cloud_sdk_core_1.CreateRequestBuilder(SupplierPartnerFunc_1.SupplierPartnerFunc, entity);
    };
    /**
    ...
    SupplierPartnerFuncRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(SupplierPartnerFunc_1.SupplierPartnerFunc, entity);
    };
    SupplierPartnerFuncRequestBuilder.prototype.delete = function (supplierOrEntity, purchasingOrganization, supplierSubrange, plant, partnerFunction, partnerCounter) {
        return new cloud_sdk_core_1.DeleteRequestBuilder(SupplierPartnerFunc_1.SupplierPartnerFunc, supplierOrEntity instanceof SupplierPartnerFunc_1.SupplierPartnerFunc ? supplierOrEntity : {
