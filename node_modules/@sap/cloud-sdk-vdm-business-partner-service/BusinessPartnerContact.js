...
var BusinessPartnerContact = /** @class */ (function (_super) {
    ...
    BusinessPartnerContact.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(BusinessPartnerContact);
    };
    /**
    ...
    BusinessPartnerContact.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, BusinessPartnerContact);
    };
    /**
...
(function (BusinessPartnerContact) {
     ...
     */
    BusinessPartnerContact.RELATIONSHIP_NUMBER = new cloud_sdk_core_1.StringField('RelationshipNumber', BusinessPartnerContact, 'Edm.String');
    /**
     * Static representation of the [[businessPartnerCompany]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerContact.BUSINESS_PARTNER_COMPANY = new cloud_sdk_core_1.StringField('BusinessPartnerCompany', BusinessPartnerContact, 'Edm.String');
    /**
     * Static representation of the [[businessPartnerPerson]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerContact.BUSINESS_PARTNER_PERSON = new cloud_sdk_core_1.StringField('BusinessPartnerPerson', BusinessPartnerContact, 'Edm.String');
    /**
     * Static representation of the [[validityEndDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerContact.VALIDITY_END_DATE = new cloud_sdk_core_1.DateField('ValidityEndDate', BusinessPartnerContact, 'Edm.DateTime');
    /**
     * Static representation of the [[validityStartDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerContact.VALIDITY_START_DATE = new cloud_sdk_core_1.DateField('ValidityStartDate', BusinessPartnerContact, 'Edm.DateTime');
    /**
     * Static representation of the [[isStandardRelationship]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerContact.IS_STANDARD_RELATIONSHIP = new cloud_sdk_core_1.BooleanField('IsStandardRelationship', BusinessPartnerContact, 'Edm.Boolean');
    /**
     * Static representation of the [[relationshipCategory]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerContact.RELATIONSHIP_CATEGORY = new cloud_sdk_core_1.StringField('RelationshipCategory', BusinessPartnerContact, 'Edm.String');
    /**
     * Static representation of the one-to-many navigation property [[toContactAddress]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerContact.TO_CONTACT_ADDRESS = new cloud_sdk_core_1.Link('to_ContactAddress', BusinessPartnerContact, BpContactToAddress_1.BpContactToAddress);
    /**
     * Static representation of the one-to-one navigation property [[toContactRelationship]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerContact.TO_CONTACT_RELATIONSHIP = new cloud_sdk_core_1.OneToOneLink('to_ContactRelationship', BusinessPartnerContact, BpContactToFuncAndDept_1.BpContactToFuncAndDept);
    /**
     ...
     * All fields selector.
     */
    BusinessPartnerContact.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', BusinessPartnerContact);
    /**
