...
var BusinessPartnerRoleRequestBuilder = /** @class */ (function (_super) {
    ...
    BusinessPartnerRoleRequestBuilder.prototype.getByKey = function (businessPartner, businessPartnerRole) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(BusinessPartnerRole_1.BusinessPartnerRole, {
    ...
    BusinessPartnerRoleRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(BusinessPartnerRole_1.BusinessPartnerRole);
    };
    /**
    ...
    BusinessPartnerRoleRequestBuilder.prototype.create = function (entity) {
        return new cloud_sdk_core_1.CreateRequestBuilder(BusinessPartnerRole_1.BusinessPartnerRole, entity);
    };
    /**
    ...
    BusinessPartnerRoleRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(BusinessPartnerRole_1.BusinessPartnerRole, entity);
    };
