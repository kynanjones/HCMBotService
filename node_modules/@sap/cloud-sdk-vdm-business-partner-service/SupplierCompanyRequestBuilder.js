...
var SupplierCompanyRequestBuilder = /** @class */ (function (_super) {
    ...
    SupplierCompanyRequestBuilder.prototype.getByKey = function (supplier, companyCode) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(SupplierCompany_1.SupplierCompany, {
            Supplier: supplier,
    ...
    SupplierCompanyRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(SupplierCompany_1.SupplierCompany);
    };
    /**
    ...
    SupplierCompanyRequestBuilder.prototype.create = function (entity) {
        return new cloud_sdk_core_1.CreateRequestBuilder(SupplierCompany_1.SupplierCompany, entity);
    };
    /**
    ...
    SupplierCompanyRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(SupplierCompany_1.SupplierCompany, entity);
    };
