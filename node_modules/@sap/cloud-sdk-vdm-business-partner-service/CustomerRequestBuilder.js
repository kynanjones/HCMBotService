...
var CustomerRequestBuilder = /** @class */ (function (_super) {
    ...
    CustomerRequestBuilder.prototype.getByKey = function (customer) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(Customer_1.Customer, { Customer: customer });
    };
    /**
    ...
    CustomerRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(Customer_1.Customer);
    };
    /**
    ...
    CustomerRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(Customer_1.Customer, entity);
    };
