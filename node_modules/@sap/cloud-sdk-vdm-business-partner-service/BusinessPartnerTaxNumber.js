...
var BusinessPartnerTaxNumber = /** @class */ (function (_super) {
    ...
    BusinessPartnerTaxNumber.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(BusinessPartnerTaxNumber);
    };
    /**
    ...
    BusinessPartnerTaxNumber.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, BusinessPartnerTaxNumber);
    };
    /**
...
(function (BusinessPartnerTaxNumber) {
     ...
     */
    BusinessPartnerTaxNumber.BUSINESS_PARTNER = new cloud_sdk_core_1.StringField('BusinessPartner', BusinessPartnerTaxNumber, 'Edm.String');
    /**
     * Static representation of the [[bpTaxType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerTaxNumber.BP_TAX_TYPE = new cloud_sdk_core_1.StringField('BPTaxType', BusinessPartnerTaxNumber, 'Edm.String');
    /**
     * Static representation of the [[bpTaxNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerTaxNumber.BP_TAX_NUMBER = new cloud_sdk_core_1.StringField('BPTaxNumber', BusinessPartnerTaxNumber, 'Edm.String');
    /**
     * Static representation of the [[authorizationGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerTaxNumber.AUTHORIZATION_GROUP = new cloud_sdk_core_1.StringField('AuthorizationGroup', BusinessPartnerTaxNumber, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    BusinessPartnerTaxNumber.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', BusinessPartnerTaxNumber);
    /**
