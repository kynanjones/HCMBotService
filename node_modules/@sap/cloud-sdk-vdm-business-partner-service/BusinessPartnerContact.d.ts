...
import { StringField, DateField, BooleanField, Link, OneToOneLink, AllFields, CustomField, Entity, EntityBuilderType, Selectable } from '@sap/cloud-sdk-core';
/**
...
export declare namespace BusinessPartnerContact {
     ...
     */
    const _keyFields: Array<Selectable<BusinessPartnerContact>>;
    /**
