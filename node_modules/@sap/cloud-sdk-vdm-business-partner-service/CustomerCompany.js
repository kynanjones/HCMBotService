...
var CustomerCompany = /** @class */ (function (_super) {
    ...
    CustomerCompany.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(CustomerCompany);
    };
    /**
    ...
    CustomerCompany.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, CustomerCompany);
    };
    /**
...
(function (CustomerCompany) {
     ...
     */
    CustomerCompany.CUSTOMER = new cloud_sdk_core_1.StringField('Customer', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[companyCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.COMPANY_CODE = new cloud_sdk_core_1.StringField('CompanyCode', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[aparToleranceGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.APAR_TOLERANCE_GROUP = new cloud_sdk_core_1.StringField('APARToleranceGroup', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[accountByCustomer]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.ACCOUNT_BY_CUSTOMER = new cloud_sdk_core_1.StringField('AccountByCustomer', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[accountingClerk]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.ACCOUNTING_CLERK = new cloud_sdk_core_1.StringField('AccountingClerk', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[accountingClerkFaxNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.ACCOUNTING_CLERK_FAX_NUMBER = new cloud_sdk_core_1.StringField('AccountingClerkFaxNumber', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[accountingClerkInternetAddress]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.ACCOUNTING_CLERK_INTERNET_ADDRESS = new cloud_sdk_core_1.StringField('AccountingClerkInternetAddress', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[accountingClerkPhoneNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.ACCOUNTING_CLERK_PHONE_NUMBER = new cloud_sdk_core_1.StringField('AccountingClerkPhoneNumber', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[alternativePayerAccount]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.ALTERNATIVE_PAYER_ACCOUNT = new cloud_sdk_core_1.StringField('AlternativePayerAccount', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[authorizationGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.AUTHORIZATION_GROUP = new cloud_sdk_core_1.StringField('AuthorizationGroup', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[collectiveInvoiceVariant]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.COLLECTIVE_INVOICE_VARIANT = new cloud_sdk_core_1.StringField('CollectiveInvoiceVariant', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[customerAccountNote]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.CUSTOMER_ACCOUNT_NOTE = new cloud_sdk_core_1.StringField('CustomerAccountNote', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[customerHeadOffice]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.CUSTOMER_HEAD_OFFICE = new cloud_sdk_core_1.StringField('CustomerHeadOffice', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[customerSupplierClearingIsUsed]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.CUSTOMER_SUPPLIER_CLEARING_IS_USED = new cloud_sdk_core_1.BooleanField('CustomerSupplierClearingIsUsed', CustomerCompany, 'Edm.Boolean');
    /**
     * Static representation of the [[houseBank]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.HOUSE_BANK = new cloud_sdk_core_1.StringField('HouseBank', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[interestCalculationCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.INTEREST_CALCULATION_CODE = new cloud_sdk_core_1.StringField('InterestCalculationCode', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[interestCalculationDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.INTEREST_CALCULATION_DATE = new cloud_sdk_core_1.DateField('InterestCalculationDate', CustomerCompany, 'Edm.DateTime');
    /**
     * Static representation of the [[intrstCalcFrequencyInMonths]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.INTRST_CALC_FREQUENCY_IN_MONTHS = new cloud_sdk_core_1.StringField('IntrstCalcFrequencyInMonths', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[isToBeLocallyProcessed]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.IS_TO_BE_LOCALLY_PROCESSED = new cloud_sdk_core_1.BooleanField('IsToBeLocallyProcessed', CustomerCompany, 'Edm.Boolean');
    /**
     * Static representation of the [[itemIsToBePaidSeparately]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.ITEM_IS_TO_BE_PAID_SEPARATELY = new cloud_sdk_core_1.BooleanField('ItemIsToBePaidSeparately', CustomerCompany, 'Edm.Boolean');
    /**
     * Static representation of the [[layoutSortingRule]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.LAYOUT_SORTING_RULE = new cloud_sdk_core_1.StringField('LayoutSortingRule', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[paymentBlockingReason]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.PAYMENT_BLOCKING_REASON = new cloud_sdk_core_1.StringField('PaymentBlockingReason', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[paymentMethodsList]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.PAYMENT_METHODS_LIST = new cloud_sdk_core_1.StringField('PaymentMethodsList', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[paymentTerms]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.PAYMENT_TERMS = new cloud_sdk_core_1.StringField('PaymentTerms', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[paytAdviceIsSentbyEdi]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.PAYT_ADVICE_IS_SENTBY_EDI = new cloud_sdk_core_1.BooleanField('PaytAdviceIsSentbyEDI', CustomerCompany, 'Edm.Boolean');
    /**
     * Static representation of the [[physicalInventoryBlockInd]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.PHYSICAL_INVENTORY_BLOCK_IND = new cloud_sdk_core_1.BooleanField('PhysicalInventoryBlockInd', CustomerCompany, 'Edm.Boolean');
    /**
     * Static representation of the [[reconciliationAccount]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.RECONCILIATION_ACCOUNT = new cloud_sdk_core_1.StringField('ReconciliationAccount', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[recordPaymentHistoryIndicator]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.RECORD_PAYMENT_HISTORY_INDICATOR = new cloud_sdk_core_1.BooleanField('RecordPaymentHistoryIndicator', CustomerCompany, 'Edm.Boolean');
    /**
     * Static representation of the [[userAtCustomer]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.USER_AT_CUSTOMER = new cloud_sdk_core_1.StringField('UserAtCustomer', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the [[deletionIndicator]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.DELETION_INDICATOR = new cloud_sdk_core_1.BooleanField('DeletionIndicator', CustomerCompany, 'Edm.Boolean');
    /**
     * Static representation of the [[customerAccountGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.CUSTOMER_ACCOUNT_GROUP = new cloud_sdk_core_1.StringField('CustomerAccountGroup', CustomerCompany, 'Edm.String');
    /**
     * Static representation of the one-to-many navigation property [[toCustomerDunning]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.TO_CUSTOMER_DUNNING = new cloud_sdk_core_1.Link('to_CustomerDunning', CustomerCompany, CustomerDunning_1.CustomerDunning);
    /**
     * Static representation of the one-to-many navigation property [[toWithHoldingTax]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerCompany.TO_WITH_HOLDING_TAX = new cloud_sdk_core_1.Link('to_WithHoldingTax', CustomerCompany, CustomerWithHoldingTax_1.CustomerWithHoldingTax);
    /**
     ...
     * All fields selector.
     */
    CustomerCompany.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', CustomerCompany);
    /**
