...
import { Time, StringField, DateField, TimeField, BooleanField, Link, OneToOneLink, AllFields, CustomField, Entity, EntityBuilderType, Selectable } from '@sap/cloud-sdk-core';
/**
...
export declare namespace BusinessPartner {
     ...
     */
    const _keyFields: Array<Selectable<BusinessPartner>>;
    /**
