...
var SupplierPurchasingOrgRequestBuilder = /** @class */ (function (_super) {
    ...
    SupplierPurchasingOrgRequestBuilder.prototype.getByKey = function (supplier, purchasingOrganization) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(SupplierPurchasingOrg_1.SupplierPurchasingOrg, {
            Supplier: supplier,
    ...
    SupplierPurchasingOrgRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(SupplierPurchasingOrg_1.SupplierPurchasingOrg);
    };
    /**
    ...
    SupplierPurchasingOrgRequestBuilder.prototype.create = function (entity) {
        return new cloud_sdk_core_1.CreateRequestBuilder(SupplierPurchasingOrg_1.SupplierPurchasingOrg, entity);
    };
    /**
    ...
    SupplierPurchasingOrgRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(SupplierPurchasingOrg_1.SupplierPurchasingOrg, entity);
    };
