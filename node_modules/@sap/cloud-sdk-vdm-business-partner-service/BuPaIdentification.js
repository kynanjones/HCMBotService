...
var BuPaIdentification = /** @class */ (function (_super) {
    ...
    BuPaIdentification.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(BuPaIdentification);
    };
    /**
    ...
    BuPaIdentification.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, BuPaIdentification);
    };
    /**
...
(function (BuPaIdentification) {
     ...
     */
    BuPaIdentification.BUSINESS_PARTNER = new cloud_sdk_core_1.StringField('BusinessPartner', BuPaIdentification, 'Edm.String');
    /**
     * Static representation of the [[bpIdentificationType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BuPaIdentification.BP_IDENTIFICATION_TYPE = new cloud_sdk_core_1.StringField('BPIdentificationType', BuPaIdentification, 'Edm.String');
    /**
     * Static representation of the [[bpIdentificationNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BuPaIdentification.BP_IDENTIFICATION_NUMBER = new cloud_sdk_core_1.StringField('BPIdentificationNumber', BuPaIdentification, 'Edm.String');
    /**
     * Static representation of the [[bpIdnNmbrIssuingInstitute]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BuPaIdentification.BP_IDN_NMBR_ISSUING_INSTITUTE = new cloud_sdk_core_1.StringField('BPIdnNmbrIssuingInstitute', BuPaIdentification, 'Edm.String');
    /**
     * Static representation of the [[bpIdentificationEntryDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BuPaIdentification.BP_IDENTIFICATION_ENTRY_DATE = new cloud_sdk_core_1.DateField('BPIdentificationEntryDate', BuPaIdentification, 'Edm.DateTime');
    /**
     * Static representation of the [[country]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BuPaIdentification.COUNTRY = new cloud_sdk_core_1.StringField('Country', BuPaIdentification, 'Edm.String');
    /**
     * Static representation of the [[region]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BuPaIdentification.REGION = new cloud_sdk_core_1.StringField('Region', BuPaIdentification, 'Edm.String');
    /**
     * Static representation of the [[validityStartDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BuPaIdentification.VALIDITY_START_DATE = new cloud_sdk_core_1.DateField('ValidityStartDate', BuPaIdentification, 'Edm.DateTime');
    /**
     * Static representation of the [[validityEndDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BuPaIdentification.VALIDITY_END_DATE = new cloud_sdk_core_1.DateField('ValidityEndDate', BuPaIdentification, 'Edm.DateTime');
    /**
     * Static representation of the [[authorizationGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BuPaIdentification.AUTHORIZATION_GROUP = new cloud_sdk_core_1.StringField('AuthorizationGroup', BuPaIdentification, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    BuPaIdentification.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', BuPaIdentification);
    /**
