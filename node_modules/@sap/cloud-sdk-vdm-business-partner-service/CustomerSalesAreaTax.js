...
var CustomerSalesAreaTax = /** @class */ (function (_super) {
    ...
    CustomerSalesAreaTax.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(CustomerSalesAreaTax);
    };
    /**
    ...
    CustomerSalesAreaTax.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, CustomerSalesAreaTax);
    };
    /**
...
(function (CustomerSalesAreaTax) {
     ...
     */
    CustomerSalesAreaTax.CUSTOMER = new cloud_sdk_core_1.StringField('Customer', CustomerSalesAreaTax, 'Edm.String');
    /**
     * Static representation of the [[salesOrganization]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerSalesAreaTax.SALES_ORGANIZATION = new cloud_sdk_core_1.StringField('SalesOrganization', CustomerSalesAreaTax, 'Edm.String');
    /**
     * Static representation of the [[distributionChannel]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerSalesAreaTax.DISTRIBUTION_CHANNEL = new cloud_sdk_core_1.StringField('DistributionChannel', CustomerSalesAreaTax, 'Edm.String');
    /**
     * Static representation of the [[division]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerSalesAreaTax.DIVISION = new cloud_sdk_core_1.StringField('Division', CustomerSalesAreaTax, 'Edm.String');
    /**
     * Static representation of the [[departureCountry]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerSalesAreaTax.DEPARTURE_COUNTRY = new cloud_sdk_core_1.StringField('DepartureCountry', CustomerSalesAreaTax, 'Edm.String');
    /**
     * Static representation of the [[customerTaxCategory]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerSalesAreaTax.CUSTOMER_TAX_CATEGORY = new cloud_sdk_core_1.StringField('CustomerTaxCategory', CustomerSalesAreaTax, 'Edm.String');
    /**
     * Static representation of the [[customerTaxClassification]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerSalesAreaTax.CUSTOMER_TAX_CLASSIFICATION = new cloud_sdk_core_1.StringField('CustomerTaxClassification', CustomerSalesAreaTax, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    CustomerSalesAreaTax.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', CustomerSalesAreaTax);
    /**
