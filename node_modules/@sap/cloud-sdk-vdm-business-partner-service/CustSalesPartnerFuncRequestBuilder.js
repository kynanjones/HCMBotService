...
var CustSalesPartnerFuncRequestBuilder = /** @class */ (function (_super) {
    ...
    CustSalesPartnerFuncRequestBuilder.prototype.getByKey = function (customer, salesOrganization, distributionChannel, division, partnerCounter, partnerFunction) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(CustSalesPartnerFunc_1.CustSalesPartnerFunc, {
            Customer: customer,
    ...
    CustSalesPartnerFuncRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(CustSalesPartnerFunc_1.CustSalesPartnerFunc);
    };
    /**
    ...
    CustSalesPartnerFuncRequestBuilder.prototype.create = function (entity) {
        return new cloud_sdk_core_1.CreateRequestBuilder(CustSalesPartnerFunc_1.CustSalesPartnerFunc, entity);
    };
    /**
    ...
    CustSalesPartnerFuncRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(CustSalesPartnerFunc_1.CustSalesPartnerFunc, entity);
    };
    CustSalesPartnerFuncRequestBuilder.prototype.delete = function (customerOrEntity, salesOrganization, distributionChannel, division, partnerCounter, partnerFunction) {
        return new cloud_sdk_core_1.DeleteRequestBuilder(CustSalesPartnerFunc_1.CustSalesPartnerFunc, customerOrEntity instanceof CustSalesPartnerFunc_1.CustSalesPartnerFunc ? customerOrEntity : {
