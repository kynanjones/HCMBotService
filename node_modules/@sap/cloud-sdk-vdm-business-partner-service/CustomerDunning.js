...
var CustomerDunning = /** @class */ (function (_super) {
    ...
    CustomerDunning.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(CustomerDunning);
    };
    /**
    ...
    CustomerDunning.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, CustomerDunning);
    };
    /**
...
(function (CustomerDunning) {
     ...
     */
    CustomerDunning.CUSTOMER = new cloud_sdk_core_1.StringField('Customer', CustomerDunning, 'Edm.String');
    /**
     * Static representation of the [[companyCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerDunning.COMPANY_CODE = new cloud_sdk_core_1.StringField('CompanyCode', CustomerDunning, 'Edm.String');
    /**
     * Static representation of the [[dunningArea]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerDunning.DUNNING_AREA = new cloud_sdk_core_1.StringField('DunningArea', CustomerDunning, 'Edm.String');
    /**
     * Static representation of the [[dunningBlock]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerDunning.DUNNING_BLOCK = new cloud_sdk_core_1.StringField('DunningBlock', CustomerDunning, 'Edm.String');
    /**
     * Static representation of the [[dunningLevel]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerDunning.DUNNING_LEVEL = new cloud_sdk_core_1.StringField('DunningLevel', CustomerDunning, 'Edm.String');
    /**
     * Static representation of the [[dunningProcedure]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerDunning.DUNNING_PROCEDURE = new cloud_sdk_core_1.StringField('DunningProcedure', CustomerDunning, 'Edm.String');
    /**
     * Static representation of the [[dunningRecipient]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerDunning.DUNNING_RECIPIENT = new cloud_sdk_core_1.StringField('DunningRecipient', CustomerDunning, 'Edm.String');
    /**
     * Static representation of the [[lastDunnedOn]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerDunning.LAST_DUNNED_ON = new cloud_sdk_core_1.DateField('LastDunnedOn', CustomerDunning, 'Edm.DateTime');
    /**
     * Static representation of the [[legDunningProcedureOn]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerDunning.LEG_DUNNING_PROCEDURE_ON = new cloud_sdk_core_1.DateField('LegDunningProcedureOn', CustomerDunning, 'Edm.DateTime');
    /**
     * Static representation of the [[dunningClerk]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerDunning.DUNNING_CLERK = new cloud_sdk_core_1.StringField('DunningClerk', CustomerDunning, 'Edm.String');
    /**
     * Static representation of the [[authorizationGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerDunning.AUTHORIZATION_GROUP = new cloud_sdk_core_1.StringField('AuthorizationGroup', CustomerDunning, 'Edm.String');
    /**
     * Static representation of the [[customerAccountGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerDunning.CUSTOMER_ACCOUNT_GROUP = new cloud_sdk_core_1.StringField('CustomerAccountGroup', CustomerDunning, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    CustomerDunning.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', CustomerDunning);
    /**
