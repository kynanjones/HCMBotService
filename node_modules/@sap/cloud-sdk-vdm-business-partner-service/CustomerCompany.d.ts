...
import { StringField, BooleanField, DateField, Link, AllFields, CustomField, Entity, EntityBuilderType, Selectable } from '@sap/cloud-sdk-core';
/**
...
export declare namespace CustomerCompany {
     ...
     */
    const _keyFields: Array<Selectable<CustomerCompany>>;
    /**
