...
var AddressHomePageUrlRequestBuilder = /** @class */ (function (_super) {
    ...
    AddressHomePageUrlRequestBuilder.prototype.getByKey = function (addressId, person, ordinalNumber, validityStartDate, isDefaultUrlAddress) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(AddressHomePageUrl_1.AddressHomePageUrl, {
            AddressID: addressId,
            Person: person,
    ...
    AddressHomePageUrlRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(AddressHomePageUrl_1.AddressHomePageUrl);
    };
    /**
    ...
    AddressHomePageUrlRequestBuilder.prototype.create = function (entity) {
        return new cloud_sdk_core_1.CreateRequestBuilder(AddressHomePageUrl_1.AddressHomePageUrl, entity);
    };
    /**
    ...
    AddressHomePageUrlRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(AddressHomePageUrl_1.AddressHomePageUrl, entity);
    };
    AddressHomePageUrlRequestBuilder.prototype.delete = function (addressIdOrEntity, person, ordinalNumber, validityStartDate, isDefaultUrlAddress) {
        return new cloud_sdk_core_1.DeleteRequestBuilder(AddressHomePageUrl_1.AddressHomePageUrl, addressIdOrEntity instanceof AddressHomePageUrl_1.AddressHomePageUrl ? addressIdOrEntity : {
