...
var CustomerDunningRequestBuilder = /** @class */ (function (_super) {
    ...
    CustomerDunningRequestBuilder.prototype.getByKey = function (customer, companyCode, dunningArea) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(CustomerDunning_1.CustomerDunning, {
            Customer: customer,
    ...
    CustomerDunningRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(CustomerDunning_1.CustomerDunning);
    };
    /**
    ...
    CustomerDunningRequestBuilder.prototype.create = function (entity) {
        return new cloud_sdk_core_1.CreateRequestBuilder(CustomerDunning_1.CustomerDunning, entity);
    };
    /**
    ...
    CustomerDunningRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(CustomerDunning_1.CustomerDunning, entity);
    };
    CustomerDunningRequestBuilder.prototype.delete = function (customerOrEntity, companyCode, dunningArea) {
        return new cloud_sdk_core_1.DeleteRequestBuilder(CustomerDunning_1.CustomerDunning, customerOrEntity instanceof CustomerDunning_1.CustomerDunning ? customerOrEntity : {
