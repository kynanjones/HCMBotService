...
var BuPaIdentificationRequestBuilder = /** @class */ (function (_super) {
    ...
    BuPaIdentificationRequestBuilder.prototype.getByKey = function (businessPartner, bpIdentificationType, bpIdentificationNumber) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(BuPaIdentification_1.BuPaIdentification, {
    ...
    BuPaIdentificationRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(BuPaIdentification_1.BuPaIdentification);
    };
    /**
    ...
    BuPaIdentificationRequestBuilder.prototype.create = function (entity) {
        return new cloud_sdk_core_1.CreateRequestBuilder(BuPaIdentification_1.BuPaIdentification, entity);
    };
    /**
    ...
    BuPaIdentificationRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(BuPaIdentification_1.BuPaIdentification, entity);
    };
    BuPaIdentificationRequestBuilder.prototype.delete = function (businessPartnerOrEntity, bpIdentificationType, bpIdentificationNumber) {
        return new cloud_sdk_core_1.DeleteRequestBuilder(BuPaIdentification_1.BuPaIdentification, businessPartnerOrEntity instanceof BuPaIdentification_1.BuPaIdentification ? businessPartnerOrEntity : {
