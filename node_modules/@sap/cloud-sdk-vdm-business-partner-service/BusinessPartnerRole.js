...
var BusinessPartnerRole = /** @class */ (function (_super) {
    ...
    BusinessPartnerRole.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(BusinessPartnerRole);
    };
    /**
    ...
    BusinessPartnerRole.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, BusinessPartnerRole);
    };
    /**
...
(function (BusinessPartnerRole) {
     ...
     */
    BusinessPartnerRole.BUSINESS_PARTNER = new cloud_sdk_core_1.StringField('BusinessPartner', BusinessPartnerRole, 'Edm.String');
    /**
     * Static representation of the [[businessPartnerRole]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerRole.BUSINESS_PARTNER_ROLE = new cloud_sdk_core_1.StringField('BusinessPartnerRole', BusinessPartnerRole, 'Edm.String');
    /**
     * Static representation of the [[validFrom]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerRole.VALID_FROM = new cloud_sdk_core_1.DateField('ValidFrom', BusinessPartnerRole, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[validTo]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerRole.VALID_TO = new cloud_sdk_core_1.DateField('ValidTo', BusinessPartnerRole, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[authorizationGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerRole.AUTHORIZATION_GROUP = new cloud_sdk_core_1.StringField('AuthorizationGroup', BusinessPartnerRole, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    BusinessPartnerRole.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', BusinessPartnerRole);
    /**
