...
var BusinessPartnerBankRequestBuilder = /** @class */ (function (_super) {
    ...
    BusinessPartnerBankRequestBuilder.prototype.getByKey = function (businessPartner, bankIdentification) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(BusinessPartnerBank_1.BusinessPartnerBank, {
    ...
    BusinessPartnerBankRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(BusinessPartnerBank_1.BusinessPartnerBank);
    };
    /**
    ...
    BusinessPartnerBankRequestBuilder.prototype.create = function (entity) {
        return new cloud_sdk_core_1.CreateRequestBuilder(BusinessPartnerBank_1.BusinessPartnerBank, entity);
    };
    /**
    ...
    BusinessPartnerBankRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(BusinessPartnerBank_1.BusinessPartnerBank, entity);
    };
    BusinessPartnerBankRequestBuilder.prototype.delete = function (businessPartnerOrEntity, bankIdentification) {
        return new cloud_sdk_core_1.DeleteRequestBuilder(BusinessPartnerBank_1.BusinessPartnerBank, businessPartnerOrEntity instanceof BusinessPartnerBank_1.BusinessPartnerBank ? businessPartnerOrEntity : {
