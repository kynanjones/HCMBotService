...
var Supplier = /** @class */ (function (_super) {
    ...
    Supplier.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(Supplier);
    };
    /**
    ...
    Supplier.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, Supplier);
    };
    /**
...
(function (Supplier) {
     ...
     */
    Supplier.SUPPLIER = new cloud_sdk_core_1.StringField('Supplier', Supplier, 'Edm.String');
    /**
     * Static representation of the [[alternativePayeeAccountNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.ALTERNATIVE_PAYEE_ACCOUNT_NUMBER = new cloud_sdk_core_1.StringField('AlternativePayeeAccountNumber', Supplier, 'Edm.String');
    /**
     * Static representation of the [[authorizationGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.AUTHORIZATION_GROUP = new cloud_sdk_core_1.StringField('AuthorizationGroup', Supplier, 'Edm.String');
    /**
     * Static representation of the [[createdByUser]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.CREATED_BY_USER = new cloud_sdk_core_1.StringField('CreatedByUser', Supplier, 'Edm.String');
    /**
     * Static representation of the [[creationDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.CREATION_DATE = new cloud_sdk_core_1.DateField('CreationDate', Supplier, 'Edm.DateTime');
    /**
     * Static representation of the [[customer]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.CUSTOMER = new cloud_sdk_core_1.StringField('Customer', Supplier, 'Edm.String');
    /**
     * Static representation of the [[paymentIsBlockedForSupplier]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.PAYMENT_IS_BLOCKED_FOR_SUPPLIER = new cloud_sdk_core_1.BooleanField('PaymentIsBlockedForSupplier', Supplier, 'Edm.Boolean');
    /**
     * Static representation of the [[postingIsBlocked]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.POSTING_IS_BLOCKED = new cloud_sdk_core_1.BooleanField('PostingIsBlocked', Supplier, 'Edm.Boolean');
    /**
     * Static representation of the [[purchasingIsBlocked]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.PURCHASING_IS_BLOCKED = new cloud_sdk_core_1.BooleanField('PurchasingIsBlocked', Supplier, 'Edm.Boolean');
    /**
     * Static representation of the [[supplierAccountGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.SUPPLIER_ACCOUNT_GROUP = new cloud_sdk_core_1.StringField('SupplierAccountGroup', Supplier, 'Edm.String');
    /**
     * Static representation of the [[supplierFullName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.SUPPLIER_FULL_NAME = new cloud_sdk_core_1.StringField('SupplierFullName', Supplier, 'Edm.String');
    /**
     * Static representation of the [[supplierName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.SUPPLIER_NAME = new cloud_sdk_core_1.StringField('SupplierName', Supplier, 'Edm.String');
    /**
     * Static representation of the [[vatRegistration]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.VAT_REGISTRATION = new cloud_sdk_core_1.StringField('VATRegistration', Supplier, 'Edm.String');
    /**
     * Static representation of the [[birthDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.BIRTH_DATE = new cloud_sdk_core_1.DateField('BirthDate', Supplier, 'Edm.DateTime');
    /**
     * Static representation of the [[concatenatedInternationalLocNo]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.CONCATENATED_INTERNATIONAL_LOC_NO = new cloud_sdk_core_1.StringField('ConcatenatedInternationalLocNo', Supplier, 'Edm.String');
    /**
     * Static representation of the [[deletionIndicator]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.DELETION_INDICATOR = new cloud_sdk_core_1.BooleanField('DeletionIndicator', Supplier, 'Edm.Boolean');
    /**
     * Static representation of the [[fiscalAddress]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.FISCAL_ADDRESS = new cloud_sdk_core_1.StringField('FiscalAddress', Supplier, 'Edm.String');
    /**
     * Static representation of the [[industry]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.INDUSTRY = new cloud_sdk_core_1.StringField('Industry', Supplier, 'Edm.String');
    /**
     * Static representation of the [[internationalLocationNumber1]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.INTERNATIONAL_LOCATION_NUMBER_1 = new cloud_sdk_core_1.StringField('InternationalLocationNumber1', Supplier, 'Edm.String');
    /**
     * Static representation of the [[internationalLocationNumber2]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.INTERNATIONAL_LOCATION_NUMBER_2 = new cloud_sdk_core_1.StringField('InternationalLocationNumber2', Supplier, 'Edm.String');
    /**
     * Static representation of the [[internationalLocationNumber3]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.INTERNATIONAL_LOCATION_NUMBER_3 = new cloud_sdk_core_1.StringField('InternationalLocationNumber3', Supplier, 'Edm.String');
    /**
     * Static representation of the [[isNaturalPerson]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.IS_NATURAL_PERSON = new cloud_sdk_core_1.StringField('IsNaturalPerson', Supplier, 'Edm.String');
    /**
     * Static representation of the [[responsibleType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.RESPONSIBLE_TYPE = new cloud_sdk_core_1.StringField('ResponsibleType', Supplier, 'Edm.String');
    /**
     * Static representation of the [[suplrQltyInProcmtCertfnValidTo]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.SUPLR_QLTY_IN_PROCMT_CERTFN_VALID_TO = new cloud_sdk_core_1.DateField('SuplrQltyInProcmtCertfnValidTo', Supplier, 'Edm.DateTime');
    /**
     * Static representation of the [[suplrQualityManagementSystem]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.SUPLR_QUALITY_MANAGEMENT_SYSTEM = new cloud_sdk_core_1.StringField('SuplrQualityManagementSystem', Supplier, 'Edm.String');
    /**
     * Static representation of the [[supplierCorporateGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.SUPPLIER_CORPORATE_GROUP = new cloud_sdk_core_1.StringField('SupplierCorporateGroup', Supplier, 'Edm.String');
    /**
     * Static representation of the [[supplierProcurementBlock]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.SUPPLIER_PROCUREMENT_BLOCK = new cloud_sdk_core_1.StringField('SupplierProcurementBlock', Supplier, 'Edm.String');
    /**
     * Static representation of the [[taxNumber1]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.TAX_NUMBER_1 = new cloud_sdk_core_1.StringField('TaxNumber1', Supplier, 'Edm.String');
    /**
     * Static representation of the [[taxNumber2]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.TAX_NUMBER_2 = new cloud_sdk_core_1.StringField('TaxNumber2', Supplier, 'Edm.String');
    /**
     * Static representation of the [[taxNumber3]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.TAX_NUMBER_3 = new cloud_sdk_core_1.StringField('TaxNumber3', Supplier, 'Edm.String');
    /**
     * Static representation of the [[taxNumber4]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.TAX_NUMBER_4 = new cloud_sdk_core_1.StringField('TaxNumber4', Supplier, 'Edm.String');
    /**
     * Static representation of the [[taxNumber5]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.TAX_NUMBER_5 = new cloud_sdk_core_1.StringField('TaxNumber5', Supplier, 'Edm.String');
    /**
     * Static representation of the [[taxNumberResponsible]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.TAX_NUMBER_RESPONSIBLE = new cloud_sdk_core_1.StringField('TaxNumberResponsible', Supplier, 'Edm.String');
    /**
     * Static representation of the [[taxNumberType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.TAX_NUMBER_TYPE = new cloud_sdk_core_1.StringField('TaxNumberType', Supplier, 'Edm.String');
    /**
     * Static representation of the one-to-many navigation property [[toSupplierCompany]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.TO_SUPPLIER_COMPANY = new cloud_sdk_core_1.Link('to_SupplierCompany', Supplier, SupplierCompany_1.SupplierCompany);
    /**
     * Static representation of the one-to-many navigation property [[toSupplierPurchasingOrg]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Supplier.TO_SUPPLIER_PURCHASING_ORG = new cloud_sdk_core_1.Link('to_SupplierPurchasingOrg', Supplier, SupplierPurchasingOrg_1.SupplierPurchasingOrg);
    /**
     ...
     * All fields selector.
     */
    Supplier.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', Supplier);
    /**
