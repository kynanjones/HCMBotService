...
var SupplierWithHoldingTaxRequestBuilder = /** @class */ (function (_super) {
    ...
    SupplierWithHoldingTaxRequestBuilder.prototype.getByKey = function (supplier, companyCode, withholdingTaxType) {
        return new cloud_sdk_core_1.GetByKeyRequestBuilder(SupplierWithHoldingTax_1.SupplierWithHoldingTax, {
            Supplier: supplier,
    ...
    SupplierWithHoldingTaxRequestBuilder.prototype.getAll = function () {
        return new cloud_sdk_core_1.GetAllRequestBuilder(SupplierWithHoldingTax_1.SupplierWithHoldingTax);
    };
    /**
    ...
    SupplierWithHoldingTaxRequestBuilder.prototype.create = function (entity) {
        return new cloud_sdk_core_1.CreateRequestBuilder(SupplierWithHoldingTax_1.SupplierWithHoldingTax, entity);
    };
    /**
    ...
    SupplierWithHoldingTaxRequestBuilder.prototype.update = function (entity) {
        return new cloud_sdk_core_1.UpdateRequestBuilder(SupplierWithHoldingTax_1.SupplierWithHoldingTax, entity);
    };
    SupplierWithHoldingTaxRequestBuilder.prototype.delete = function (supplierOrEntity, companyCode, withholdingTaxType) {
        return new cloud_sdk_core_1.DeleteRequestBuilder(SupplierWithHoldingTax_1.SupplierWithHoldingTax, supplierOrEntity instanceof SupplierWithHoldingTax_1.SupplierWithHoldingTax ? supplierOrEntity : {
