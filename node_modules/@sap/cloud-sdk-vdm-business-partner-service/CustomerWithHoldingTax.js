...
var CustomerWithHoldingTax = /** @class */ (function (_super) {
    ...
    CustomerWithHoldingTax.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(CustomerWithHoldingTax);
    };
    /**
    ...
    CustomerWithHoldingTax.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, CustomerWithHoldingTax);
    };
    /**
...
(function (CustomerWithHoldingTax) {
     ...
     */
    CustomerWithHoldingTax.CUSTOMER = new cloud_sdk_core_1.StringField('Customer', CustomerWithHoldingTax, 'Edm.String');
    /**
     * Static representation of the [[companyCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerWithHoldingTax.COMPANY_CODE = new cloud_sdk_core_1.StringField('CompanyCode', CustomerWithHoldingTax, 'Edm.String');
    /**
     * Static representation of the [[withholdingTaxType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerWithHoldingTax.WITHHOLDING_TAX_TYPE = new cloud_sdk_core_1.StringField('WithholdingTaxType', CustomerWithHoldingTax, 'Edm.String');
    /**
     * Static representation of the [[withholdingTaxCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerWithHoldingTax.WITHHOLDING_TAX_CODE = new cloud_sdk_core_1.StringField('WithholdingTaxCode', CustomerWithHoldingTax, 'Edm.String');
    /**
     * Static representation of the [[withholdingTaxAgent]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerWithHoldingTax.WITHHOLDING_TAX_AGENT = new cloud_sdk_core_1.BooleanField('WithholdingTaxAgent', CustomerWithHoldingTax, 'Edm.Boolean');
    /**
     * Static representation of the [[obligationDateBegin]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerWithHoldingTax.OBLIGATION_DATE_BEGIN = new cloud_sdk_core_1.DateField('ObligationDateBegin', CustomerWithHoldingTax, 'Edm.DateTime');
    /**
     * Static representation of the [[obligationDateEnd]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerWithHoldingTax.OBLIGATION_DATE_END = new cloud_sdk_core_1.DateField('ObligationDateEnd', CustomerWithHoldingTax, 'Edm.DateTime');
    /**
     * Static representation of the [[withholdingTaxNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerWithHoldingTax.WITHHOLDING_TAX_NUMBER = new cloud_sdk_core_1.StringField('WithholdingTaxNumber', CustomerWithHoldingTax, 'Edm.String');
    /**
     * Static representation of the [[withholdingTaxCertificate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerWithHoldingTax.WITHHOLDING_TAX_CERTIFICATE = new cloud_sdk_core_1.StringField('WithholdingTaxCertificate', CustomerWithHoldingTax, 'Edm.String');
    /**
     * Static representation of the [[withholdingTaxExmptPercent]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerWithHoldingTax.WITHHOLDING_TAX_EXMPT_PERCENT = new cloud_sdk_core_1.BigNumberField('WithholdingTaxExmptPercent', CustomerWithHoldingTax, 'Edm.Decimal');
    /**
     * Static representation of the [[exemptionDateBegin]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerWithHoldingTax.EXEMPTION_DATE_BEGIN = new cloud_sdk_core_1.DateField('ExemptionDateBegin', CustomerWithHoldingTax, 'Edm.DateTime');
    /**
     * Static representation of the [[exemptionDateEnd]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerWithHoldingTax.EXEMPTION_DATE_END = new cloud_sdk_core_1.DateField('ExemptionDateEnd', CustomerWithHoldingTax, 'Edm.DateTime');
    /**
     * Static representation of the [[exemptionReason]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerWithHoldingTax.EXEMPTION_REASON = new cloud_sdk_core_1.StringField('ExemptionReason', CustomerWithHoldingTax, 'Edm.String');
    /**
     * Static representation of the [[authorizationGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CustomerWithHoldingTax.AUTHORIZATION_GROUP = new cloud_sdk_core_1.StringField('AuthorizationGroup', CustomerWithHoldingTax, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    CustomerWithHoldingTax.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', CustomerWithHoldingTax);
    /**
