...
var SupplierPartnerFunc = /** @class */ (function (_super) {
    ...
    SupplierPartnerFunc.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(SupplierPartnerFunc);
    };
    /**
    ...
    SupplierPartnerFunc.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, SupplierPartnerFunc);
    };
    /**
...
(function (SupplierPartnerFunc) {
     ...
     */
    SupplierPartnerFunc.SUPPLIER = new cloud_sdk_core_1.StringField('Supplier', SupplierPartnerFunc, 'Edm.String');
    /**
     * Static representation of the [[purchasingOrganization]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPartnerFunc.PURCHASING_ORGANIZATION = new cloud_sdk_core_1.StringField('PurchasingOrganization', SupplierPartnerFunc, 'Edm.String');
    /**
     * Static representation of the [[supplierSubrange]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPartnerFunc.SUPPLIER_SUBRANGE = new cloud_sdk_core_1.StringField('SupplierSubrange', SupplierPartnerFunc, 'Edm.String');
    /**
     * Static representation of the [[plant]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPartnerFunc.PLANT = new cloud_sdk_core_1.StringField('Plant', SupplierPartnerFunc, 'Edm.String');
    /**
     * Static representation of the [[partnerFunction]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPartnerFunc.PARTNER_FUNCTION = new cloud_sdk_core_1.StringField('PartnerFunction', SupplierPartnerFunc, 'Edm.String');
    /**
     * Static representation of the [[partnerCounter]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPartnerFunc.PARTNER_COUNTER = new cloud_sdk_core_1.StringField('PartnerCounter', SupplierPartnerFunc, 'Edm.String');
    /**
     * Static representation of the [[defaultPartner]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPartnerFunc.DEFAULT_PARTNER = new cloud_sdk_core_1.BooleanField('DefaultPartner', SupplierPartnerFunc, 'Edm.Boolean');
    /**
     * Static representation of the [[creationDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPartnerFunc.CREATION_DATE = new cloud_sdk_core_1.DateField('CreationDate', SupplierPartnerFunc, 'Edm.DateTime');
    /**
     * Static representation of the [[createdByUser]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPartnerFunc.CREATED_BY_USER = new cloud_sdk_core_1.StringField('CreatedByUser', SupplierPartnerFunc, 'Edm.String');
    /**
     * Static representation of the [[referenceSupplier]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPartnerFunc.REFERENCE_SUPPLIER = new cloud_sdk_core_1.StringField('ReferenceSupplier', SupplierPartnerFunc, 'Edm.String');
    /**
     * Static representation of the [[authorizationGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SupplierPartnerFunc.AUTHORIZATION_GROUP = new cloud_sdk_core_1.StringField('AuthorizationGroup', SupplierPartnerFunc, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    SupplierPartnerFunc.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', SupplierPartnerFunc);
    /**
