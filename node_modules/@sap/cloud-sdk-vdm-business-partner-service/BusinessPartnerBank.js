...
var BusinessPartnerBank = /** @class */ (function (_super) {
    ...
    BusinessPartnerBank.builder = function () {
        return cloud_sdk_core_1.Entity.entityBuilder(BusinessPartnerBank);
    };
    /**
    ...
    BusinessPartnerBank.customField = function (fieldName) {
        return cloud_sdk_core_1.Entity.customFieldSelector(fieldName, BusinessPartnerBank);
    };
    /**
...
(function (BusinessPartnerBank) {
     ...
     */
    BusinessPartnerBank.BUSINESS_PARTNER = new cloud_sdk_core_1.StringField('BusinessPartner', BusinessPartnerBank, 'Edm.String');
    /**
     * Static representation of the [[bankIdentification]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerBank.BANK_IDENTIFICATION = new cloud_sdk_core_1.StringField('BankIdentification', BusinessPartnerBank, 'Edm.String');
    /**
     * Static representation of the [[bankCountryKey]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerBank.BANK_COUNTRY_KEY = new cloud_sdk_core_1.StringField('BankCountryKey', BusinessPartnerBank, 'Edm.String');
    /**
     * Static representation of the [[bankName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerBank.BANK_NAME = new cloud_sdk_core_1.StringField('BankName', BusinessPartnerBank, 'Edm.String');
    /**
     * Static representation of the [[bankNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerBank.BANK_NUMBER = new cloud_sdk_core_1.StringField('BankNumber', BusinessPartnerBank, 'Edm.String');
    /**
     * Static representation of the [[swiftCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerBank.SWIFT_CODE = new cloud_sdk_core_1.StringField('SWIFTCode', BusinessPartnerBank, 'Edm.String');
    /**
     * Static representation of the [[bankControlKey]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerBank.BANK_CONTROL_KEY = new cloud_sdk_core_1.StringField('BankControlKey', BusinessPartnerBank, 'Edm.String');
    /**
     * Static representation of the [[bankAccountHolderName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerBank.BANK_ACCOUNT_HOLDER_NAME = new cloud_sdk_core_1.StringField('BankAccountHolderName', BusinessPartnerBank, 'Edm.String');
    /**
     * Static representation of the [[bankAccountName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerBank.BANK_ACCOUNT_NAME = new cloud_sdk_core_1.StringField('BankAccountName', BusinessPartnerBank, 'Edm.String');
    /**
     * Static representation of the [[validityStartDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerBank.VALIDITY_START_DATE = new cloud_sdk_core_1.DateField('ValidityStartDate', BusinessPartnerBank, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[validityEndDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerBank.VALIDITY_END_DATE = new cloud_sdk_core_1.DateField('ValidityEndDate', BusinessPartnerBank, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[iban]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerBank.IBAN = new cloud_sdk_core_1.StringField('IBAN', BusinessPartnerBank, 'Edm.String');
    /**
     * Static representation of the [[ibanValidityStartDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerBank.IBAN_VALIDITY_START_DATE = new cloud_sdk_core_1.DateField('IBANValidityStartDate', BusinessPartnerBank, 'Edm.DateTime');
    /**
     * Static representation of the [[bankAccount]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerBank.BANK_ACCOUNT = new cloud_sdk_core_1.StringField('BankAccount', BusinessPartnerBank, 'Edm.String');
    /**
     * Static representation of the [[bankAccountReferenceText]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerBank.BANK_ACCOUNT_REFERENCE_TEXT = new cloud_sdk_core_1.StringField('BankAccountReferenceText', BusinessPartnerBank, 'Edm.String');
    /**
     * Static representation of the [[collectionAuthInd]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerBank.COLLECTION_AUTH_IND = new cloud_sdk_core_1.BooleanField('CollectionAuthInd', BusinessPartnerBank, 'Edm.Boolean');
    /**
     * Static representation of the [[cityName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerBank.CITY_NAME = new cloud_sdk_core_1.StringField('CityName', BusinessPartnerBank, 'Edm.String');
    /**
     * Static representation of the [[authorizationGroup]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerBank.AUTHORIZATION_GROUP = new cloud_sdk_core_1.StringField('AuthorizationGroup', BusinessPartnerBank, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    BusinessPartnerBank.ALL_FIELDS = new cloud_sdk_core_1.AllFields('*', BusinessPartnerBank);
    /**
