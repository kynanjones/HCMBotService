 ...
 */
export declare class DateFieldBase<EntityT extends Entity> extends EdmTypeField<EntityT, Moment> {
    /**
 ...
 * @typeparam EntityT Type of the entity the field belongs to
 */
export declare class DateField<EntityT extends Entity> extends DateFieldBase<EntityT> implements SelectableEdmTypeField {
 ...
 * @typeparam EntityT Type of the entity the field belongs to
 */
export declare class ComplexTypeDatePropertyField<EntityT extends Entity> extends DateFieldBase<EntityT> {
