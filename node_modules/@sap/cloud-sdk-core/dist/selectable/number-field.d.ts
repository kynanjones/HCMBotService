 ...
 */
export declare class NumberFieldBase<EntityT extends Entity> extends EdmTypeField<EntityT, number> {
    /**
 ...
 * @typeparam EntityT Type of the entity the field belongs to
 */
export declare class NumberField<EntityT extends Entity> extends NumberFieldBase<EntityT> implements SelectableEdmTypeField {
 ...
 * @typeparam EntityT Type of the entity the field belongs to
 */
export declare class ComplexTypeNumberPropertyField<EntityT extends Entity> extends NumberFieldBase<EntityT> {
