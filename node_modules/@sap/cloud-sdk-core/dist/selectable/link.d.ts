 ...
 */
export declare class Link<EntityT extends Entity, LinkedEntityT extends Entity> implements EntityIdentifiable<EntityT> {
    readonly fieldName: string;
    readonly entityConstructor: Constructable<EntityT>;
    readonly linkedEntity: Constructable<LinkedEntityT>;
    /**
     ...
     */
    constructor(fieldName: string, entityConstructor: Constructable<EntityT>, linkedEntity: Constructable<LinkedEntityT>);
    /**
