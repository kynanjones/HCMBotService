 ...
 */
export declare function useOrFetchDestination(destination: Destination | DestinationNameAndJwt, options?: DestinationRetrievalOptions): Promise<Destination>;
export interface DestinationOptions extends DestinationRetrievalOptions {
    /**
     * Method that implements the selection strategy of the retrieved destination. Select subscriber destination first per default.
     */
