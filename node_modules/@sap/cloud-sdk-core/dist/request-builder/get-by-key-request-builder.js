...
var odata_get_by_key_request_config_1 = require("./request/odata-get-by-key-request-config");
/**
...
var GetByKeyRequestBuilder = /** @class */ (function (_super) {
     ...
     */
    function GetByKeyRequestBuilder(entityConstructor, keys) {
        var _this = _super.call(this, new odata_get_by_key_request_config_1.ODataGetByKeyRequestConfig(entityConstructor)) || this;
     ...
     */
    GetByKeyRequestBuilder.prototype.select = function () {
        var selects = [];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.build(destination, options)
                        ...
                        .then(function (response) { return _this.entityConstructor.builder().fromJson(response.data.d, _this.extractEtagFromHeader(response)); })
                        .catch(function (error) { return Promise.reject(cloud_sdk_util_1.errorWithCause('OData get by key request failed!', error)); })];
            });
        });
    };
    GetByKeyRequestBuilder.prototype.extractEtagFromHeader = function (response) {
