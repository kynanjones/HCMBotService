...
var ODataFunctionImportRequestConfig = /** @class */ (function (_super) {
    ...
    ODataFunctionImportRequestConfig.prototype.queryParameters = function () {
        return __assign({}, this.prependDollarToQueryParameters({
            ...
            .filter(function (parameter) { return typeof parameter.value !== 'undefined'; })
            .reduce(function (queryParams, parameter) {
            queryParams[parameter.originalName] = uri_value_converter_1.convertToUriFormat(parameter.value, parameter.edmType);
            return queryParams;
        }, {}));
    };
