...
var get_filters_1 = require("./get-filters");
var get_orderby_1 = require("./get-orderby");
var get_selection_1 = require("./get-selection");
...
var ODataGetAllRequestConfig = /** @class */ (function (_super) {
     ...
     */
    function ODataGetAllRequestConfig(entityConstructor) {
    ...
    ODataGetAllRequestConfig.prototype.queryParameters = function () {
        var params = __assign({ format: 'json' }, get_selection_1.getQueryParametersForSelection(this.selects), get_filters_1.getQueryParametersForFilter(this.filter, this.entityConstructor), get_orderby_1.getQueryParametersForOrderBy(this.orderBy));
