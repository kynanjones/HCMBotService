...
var odata_delete_request_config_1 = require("./request/odata-delete-request-config");
/**
...
var DeleteRequestBuilder = /** @class */ (function (_super) {
    ...
    function DeleteRequestBuilder(entityConstructor, keysOrEntity) {
        var _this = _super.call(this, new odata_delete_request_config_1.ODataDeleteRequestConfig(entityConstructor)) || this;
        _this.entityConstructor = entityConstructor;
        if (keysOrEntity instanceof entity_1.Entity) {
            _this.requestConfig.keys = get_keys_1.getEntityKeys(keysOrEntity, entityConstructor);
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.build(destination, options)
                        ...
                        .catch(function (error) { return Promise.reject(cloud_sdk_util_1.errorWithCause('OData delete request failed!', error)); })];
            });
        });
    };
