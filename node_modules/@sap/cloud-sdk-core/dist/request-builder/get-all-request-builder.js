...
var filterable_1 = require("../filter/filterable");
var request_builder_base_1 = require("./request-builder-base");
var odata_get_all_request_config_1 = require("./request/odata-get-all-request-config");
/**
...
var GetAllRequestBuilder = /** @class */ (function (_super) {
    ...
    function GetAllRequestBuilder(entityConstructor) {
        var _this = _super.call(this, new odata_get_all_request_config_1.ODataGetAllRequestConfig(entityConstructor)) || this;
     ...
     */
    GetAllRequestBuilder.prototype.select = function () {
        var selects = [];
    ...
    GetAllRequestBuilder.prototype.filter = function () {
        ...
        this.requestConfig.filter = filterable_1.and.apply(void 0, expressions);
        return this;
    };
    /**
     ...
     * @returns The request builder itself, to facilitate method chaining
     */
    GetAllRequestBuilder.prototype.orderBy = function () {
        var orderBy = [];
        for (var _i = 0; _i < arguments.length; _i++) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.build(destination, options)
                        ...
                        .then(function (response) { return response.data.d.results.map(function (entityJson) { return _this.entityConstructor.builder().fromJson(entityJson); }); })];
            });
        });
    };
