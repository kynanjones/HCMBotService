 ...
 */
export declare type Filterable<EntityT extends Entity> = Filter<EntityT, FieldType> | FilterLink<EntityT, Entity> | FilterList<EntityT>;
/**
 ...
 */
export declare function and<EntityT extends Entity>(...expressions: Array<Filterable<EntityT>>): FilterList<EntityT>;
/**
 ...
 * @returns The newly created FilterList
 */
export declare function or<EntityT extends Entity>(...expressions: Array<Filterable<EntityT>>): FilterList<EntityT>;
